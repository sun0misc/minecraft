...
public class LootGsons {
   ...
   public static GsonBuilder getFunctionGsonBuilder() {
      return getConditionGsonBuilder().registerTypeHierarchyAdapter(LootPoolEntry.class, LootPoolEntryTypes.createGsonSerializer()).registerTypeHierarchyAdapter(LootFunction.class, LootFunctionTypes.createGsonSerializer()).registerTypeHierarchyAdapter(LootNbtProvider.class, LootNbtProviderTypes.createGsonSerializer());
   }

   public static GsonBuilder getTableGsonBuilder() {
      return getFunctionGsonBuilder().registerTypeAdapter(LootPool.class, new LootPool.Serializer()).registerTypeAdapter(LootTable.class, new LootTable.Serializer());
   }
}
