...
public class LootTables {
   ...
   public static final Identifier ANCIENT_CITY_ICE_BOX_CHEST;
   ...
   public static final Identifier DESERT_WELL_ARCHAEOLOGY;
   public static final Identifier DESERT_PYRAMID_ARCHAEOLOGY;
   public static final Identifier TRAIL_RUINS_ARCHAEOLOGY;
   public static final Identifier OCEAN_RUIN_WARM_ARCHAEOLOGY;
   public static final Identifier OCEAN_RUIN_COLD_ARCHAEOLOGY;
   ...
   static {
      ...
      TRAIL_RUINS_ARCHAEOLOGY = register("archaeology/trail_ruins");
