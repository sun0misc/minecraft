...
public class LootPoolEntryTypes {
   ...
   private static LootPoolEntryType register(String id, JsonSerializer jsonSerializer) {
      return (LootPoolEntryType)Registry.register(Registries.LOOT_POOL_ENTRY_TYPE, (Identifier)(new Identifier(id)), new LootPoolEntryType(jsonSerializer));
   }
