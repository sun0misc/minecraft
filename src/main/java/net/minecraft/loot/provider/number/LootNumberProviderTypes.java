...
public class LootNumberProviderTypes {
   ...
   private static LootNumberProviderType register(String id, JsonSerializer jsonSerializer) {
      return (LootNumberProviderType)Registry.register(Registries.LOOT_NUMBER_PROVIDER_TYPE, (Identifier)(new Identifier(id)), new LootNumberProviderType(jsonSerializer));
   }
