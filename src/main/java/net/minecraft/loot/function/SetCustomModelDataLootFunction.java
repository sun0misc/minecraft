...
extends ConditionalLootFunction {
    static final MapCodec<SetCustomModelDataLootFunction> CODEC = RecordCodecBuilder.mapCodec(instance -> SetCustomModelDataLootFunction.addConditionsField(instance).and(((MapCodec)LootNumberProviderTypes.CODEC.fieldOf("value")).forGetter(lootFunction -> lootFunction.value)).apply((Applicative<SetCustomModelDataLootFunction, ?>)instance, SetCustomModelDataLootFunction::new));
