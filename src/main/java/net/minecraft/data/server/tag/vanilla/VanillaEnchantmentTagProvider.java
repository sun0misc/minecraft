...
extends EnchantmentTagProvider {
    ...
    protected void configure(RegistryWrapper.WrapperLookup lookup) {
        ...
        this.getOrCreateTagBuilder(EnchantmentTags.DAMAGE_EXCLUSIVE_SET).add(Enchantments.SHARPNESS, Enchantments.SMITE, Enchantments.BANE_OF_ARTHROPODS, Enchantments.IMPALING, Enchantments.DENSITY, Enchantments.BREACH);
        ...
        this.getOrCreateTagBuilder(EnchantmentTags.ON_RANDOM_LOOT).addTag(EnchantmentTags.NON_TREASURE).add(Enchantments.BINDING_CURSE, Enchantments.VANISHING_CURSE, Enchantments.FROST_WALKER, Enchantments.MENDING);
        this.getOrCreateTagBuilder(EnchantmentTags.TRADEABLE).addTag(EnchantmentTags.NON_TREASURE).add(Enchantments.BINDING_CURSE, Enchantments.VANISHING_CURSE, Enchantments.FROST_WALKER, Enchantments.MENDING);
