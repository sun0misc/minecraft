...
public class VanillaBiomeTagProvider extends TagProvider {
   public VanillaBiomeTagProvider(DataOutput output, CompletableFuture registryLookupFuture) {
   ...
   protected void configure(RegistryWrapper.WrapperLookup lookup) {
      ...
      TagProvider.ProvidedTagBuilder lv = this.getOrCreateTagBuilder(BiomeTags.IS_NETHER);
      Stream var10000 = MultiNoiseBiomeSourceParameterList.Preset.NETHER.biomeStream();
      Objects.requireNonNull(lv);
      var10000.forEach(lv::add);
      TagProvider.ProvidedTagBuilder lv2 = this.getOrCreateTagBuilder(BiomeTags.IS_OVERWORLD);
      var10000 = MultiNoiseBiomeSourceParameterList.Preset.OVERWORLD.biomeStream();
