...
public class VanillaFlatLevelGeneratorPresetTagProvider extends TagProvider {
   public VanillaFlatLevelGeneratorPresetTagProvider(DataOutput output, CompletableFuture registryLookupFuture) {
