...
public class VanillaBannerPatternTagProvider extends TagProvider {
   public VanillaBannerPatternTagProvider(DataOutput dataGenerator, CompletableFuture registryLookupFuture) {
