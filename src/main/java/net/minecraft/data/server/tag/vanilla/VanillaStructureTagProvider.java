...
public class VanillaStructureTagProvider extends TagProvider {
   public VanillaStructureTagProvider(DataOutput output, CompletableFuture registryLookupFuture) {
