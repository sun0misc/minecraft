...
public class VanillaDamageTypeTagProvider extends TagProvider {
   public VanillaDamageTypeTagProvider(DataOutput output, CompletableFuture maxChainedNeighborUpdates) {
