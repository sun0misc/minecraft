...
public class VanillaCatVariantTagProvider extends TagProvider {
   public VanillaCatVariantTagProvider(DataOutput output, CompletableFuture registryLookupFuture) {
