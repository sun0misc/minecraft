...
public class CookingRecipeJsonBuilder implements CraftingRecipeJsonBuilder {
   ...
   private CookingRecipeJsonBuilder(RecipeCategory category, CookingRecipeCategory cookingCategory, ItemConvertible output, Ingredient input, float experience, int cookingTime, RecipeSerializer serializer) {
   ...
   public static CookingRecipeJsonBuilder create(Ingredient input, RecipeCategory category, ItemConvertible output, float experience, int cookingTime, RecipeSerializer serializer) {
   ...
   public CookingRecipeJsonBuilder criterion(String string, CriterionConditions arg) {
   ...
   static class CookingRecipeJsonProvider implements RecipeJsonProvider {
      ...
      public CookingRecipeJsonProvider(Identifier recipeId, String group, CookingRecipeCategory category, Ingredient input, Item result, float experience, int cookingTime, Advancement.Builder advancementBuilder, Identifier advancementId, RecipeSerializer serializer) {
