...
extends BlockLootTableGenerator {
    ...
    protected void generate() {
        ...
        this.addDrop(Blocks.PLAYER_HEAD, (Block block) -> LootTable.builder().pool(this.addSurvivesExplosionCondition((ItemConvertible)block, LootPool.builder().rolls(ConstantLootNumberProvider.create(1.0f)).with((LootPoolEntry.Builder<?>)((Object)ItemEntry.builder(block).apply(CopyComponentsLootFunction.builder(CopyComponentsLootFunction.Source.BLOCK_ENTITY).include(DataComponentTypes.PROFILE).include(DataComponentTypes.NOTE_BLOCK_SOUND).include(DataComponentTypes.CUSTOM_NAME)))))));
        ...
        BlockStatePropertyLootCondition.Builder lv2 = BlockStatePropertyLootCondition.builder(Blocks.BEETROOTS).properties(StatePredicate.Builder.create().exactMatch(BeetrootsBlock.AGE, 3));
        this.addDrop(Blocks.BEETROOTS, this.cropDrops(Blocks.BEETROOTS, Items.BEETROOT, Items.BEETROOT_SEEDS, lv2));
        BlockStatePropertyLootCondition.Builder lv3 = BlockStatePropertyLootCondition.builder(Blocks.WHEAT).properties(StatePredicate.Builder.create().exactMatch(CropBlock.AGE, 7));
        this.addDrop(Blocks.WHEAT, this.cropDrops(Blocks.WHEAT, Items.WHEAT, Items.WHEAT_SEEDS, lv3));
        BlockStatePropertyLootCondition.Builder lv4 = BlockStatePropertyLootCondition.builder(Blocks.CARROTS).properties(StatePredicate.Builder.create().exactMatch(CarrotsBlock.AGE, 7));
        BlockStatePropertyLootCondition.Builder lv5 = BlockStatePropertyLootCondition.builder(Blocks.MANGROVE_PROPAGULE).properties(StatePredicate.Builder.create().exactMatch(PropaguleBlock.AGE, 4));
        this.addDrop(Blocks.MANGROVE_PROPAGULE, this.applyExplosionDecay(Blocks.MANGROVE_PROPAGULE, LootTable.builder().pool(LootPool.builder().conditionally(lv5).with(ItemEntry.builder(Items.MANGROVE_PROPAGULE)))));
        ...
        this.addDrop(Blocks.CARROTS, this.applyExplosionDecay(Blocks.CARROTS, LootTable.builder().pool(LootPool.builder().with(ItemEntry.builder(Items.CARROT))).pool(LootPool.builder().conditionally(lv4).with((LootPoolEntry.Builder<?>)((Object)ItemEntry.builder(Items.CARROT).apply(ApplyBonusLootFunction.binomialWithBonusCount(lv.getOrThrow(Enchantments.FORTUNE), 0.5714286f, 3)))))));
        BlockStatePropertyLootCondition.Builder lv6 = BlockStatePropertyLootCondition.builder(Blocks.POTATOES).properties(StatePredicate.Builder.create().exactMatch(PotatoesBlock.AGE, 7));
        this.addDrop(Blocks.POTATOES, this.applyExplosionDecay(Blocks.POTATOES, LootTable.builder().pool(LootPool.builder().with(ItemEntry.builder(Items.POTATO))).pool(LootPool.builder().conditionally(lv6).with((LootPoolEntry.Builder<?>)((Object)ItemEntry.builder(Items.POTATO).apply(ApplyBonusLootFunction.binomialWithBonusCount(lv.getOrThrow(Enchantments.FORTUNE), 0.5714286f, 3))))).pool(LootPool.builder().conditionally(lv6).with((LootPoolEntry.Builder<?>)ItemEntry.builder(Items.POISONOUS_POTATO).conditionally(RandomChanceLootCondition.builder(0.02f))))));
        this.addDrop(Blocks.SWEET_BERRY_BUSH, (Block block) -> this.applyExplosionDecay((ItemConvertible)block, LootTable.builder().pool(LootPool.builder().conditionally(BlockStatePropertyLootCondition.builder(Blocks.SWEET_BERRY_BUSH).properties(StatePredicate.Builder.create().exactMatch(SweetBerryBushBlock.AGE, 3))).with(ItemEntry.builder(Items.SWEET_BERRIES)).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(2.0f, 3.0f))).apply(ApplyBonusLootFunction.uniformBonusCount(lv.getOrThrow(Enchantments.FORTUNE)))).pool(LootPool.builder().conditionally(BlockStatePropertyLootCondition.builder(Blocks.SWEET_BERRY_BUSH).properties(StatePredicate.Builder.create().exactMatch(SweetBerryBushBlock.AGE, 2))).with(ItemEntry.builder(Items.SWEET_BERRIES)).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1.0f, 2.0f))).apply(ApplyBonusLootFunction.uniformBonusCount(lv.getOrThrow(Enchantments.FORTUNE))))));
        ...
        this.addDrop(Blocks.NETHER_GOLD_ORE, (Block block) -> this.dropsWithSilkTouch((Block)block, (LootPoolEntry.Builder)this.applyExplosionDecay((ItemConvertible)block, ((LeafEntry.Builder)ItemEntry.builder(Items.GOLD_NUGGET).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(2.0f, 6.0f)))).apply(ApplyBonusLootFunction.oreDrops(lv.getOrThrow(Enchantments.FORTUNE))))));
        ...
        this.addDrop(Blocks.GLOWSTONE, (Block block) -> this.dropsWithSilkTouch((Block)block, (LootPoolEntry.Builder)this.applyExplosionDecay((ItemConvertible)block, ((LeafEntry.Builder)((LeafEntry.Builder)ItemEntry.builder(Items.GLOWSTONE_DUST).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(2.0f, 4.0f)))).apply(ApplyBonusLootFunction.uniformBonusCount(lv.getOrThrow(Enchantments.FORTUNE)))).apply(LimitCountLootFunction.builder(BoundedIntUnaryOperator.create(1, 4))))));
        this.addDrop(Blocks.MELON, (Block block) -> this.dropsWithSilkTouch((Block)block, (LootPoolEntry.Builder)this.applyExplosionDecay((ItemConvertible)block, ((LeafEntry.Builder)((LeafEntry.Builder)ItemEntry.builder(Items.MELON_SLICE).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(3.0f, 7.0f)))).apply(ApplyBonusLootFunction.uniformBonusCount(lv.getOrThrow(Enchantments.FORTUNE)))).apply(LimitCountLootFunction.builder(BoundedIntUnaryOperator.createMax(9))))));
        ...
        this.addDrop(Blocks.SEA_LANTERN, (Block block) -> this.dropsWithSilkTouch((Block)block, (LootPoolEntry.Builder)this.applyExplosionDecay((ItemConvertible)block, ((LeafEntry.Builder)((LeafEntry.Builder)ItemEntry.builder(Items.PRISMARINE_CRYSTALS).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(2.0f, 3.0f)))).apply(ApplyBonusLootFunction.uniformBonusCount(lv.getOrThrow(Enchantments.FORTUNE)))).apply(LimitCountLootFunction.builder(BoundedIntUnaryOperator.create(1, 5))))));
        this.addDrop(Blocks.NETHER_WART, (Block block) -> LootTable.builder().pool(this.applyExplosionDecay((ItemConvertible)block, LootPool.builder().rolls(ConstantLootNumberProvider.create(1.0f)).with((LootPoolEntry.Builder<?>)((Object)((LeafEntry.Builder)ItemEntry.builder(Items.NETHER_WART).apply((LootFunction.Builder)((Object)SetCountLootFunction.builder(UniformLootNumberProvider.create(2.0f, 4.0f)).conditionally(BlockStatePropertyLootCondition.builder(block).properties(StatePredicate.Builder.create().exactMatch(NetherWartBlock.AGE, 3)))))).apply((LootFunction.Builder)((Object)ApplyBonusLootFunction.uniformBonusCount(lv.getOrThrow(Enchantments.FORTUNE)).conditionally(BlockStatePropertyLootCondition.builder(block).properties(StatePredicate.Builder.create().exactMatch(NetherWartBlock.AGE, 3))))))))));
        this.addDrop(Blocks.SNOW, (Block block) -> LootTable.builder().pool(LootPool.builder().conditionally(EntityPropertiesLootCondition.create(LootContext.EntityTarget.THIS)).with(AlternativeEntry.builder(new LootPoolEntry.Builder[]{AlternativeEntry.builder(SnowBlock.LAYERS.getValues(), integer -> ((LeafEntry.Builder)ItemEntry.builder(Items.SNOWBALL).conditionally(BlockStatePropertyLootCondition.builder(block).properties(StatePredicate.Builder.create().exactMatch(SnowBlock.LAYERS, integer.intValue())))).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(integer.intValue())))).conditionally(this.createWithoutSilkTouchCondition()), AlternativeEntry.builder(SnowBlock.LAYERS.getValues(), integer -> integer == 8 ? ItemEntry.builder(Blocks.SNOW_BLOCK) : ((LootPoolEntry.Builder)((Object)ItemEntry.builder(Blocks.SNOW).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(integer.intValue()))))).conditionally(BlockStatePropertyLootCondition.builder(block).properties(StatePredicate.Builder.create().exactMatch(SnowBlock.LAYERS, integer.intValue()))))}))));
        this.addDrop(Blocks.GRAVEL, (Block block) -> this.dropsWithSilkTouch((Block)block, this.addSurvivesExplosionCondition((ItemConvertible)block, ((LeafEntry.Builder)ItemEntry.builder(Items.FLINT).conditionally(TableBonusLootCondition.builder(lv.getOrThrow(Enchantments.FORTUNE), 0.1f, 0.14285715f, 0.25f, 1.0f))).alternatively(ItemEntry.builder(block)))));
        ...
        this.addDrop(Blocks.GILDED_BLACKSTONE, (Block block) -> this.dropsWithSilkTouch((Block)block, this.addSurvivesExplosionCondition((ItemConvertible)block, ((LeafEntry.Builder)((LootPoolEntry.Builder)((Object)ItemEntry.builder(Items.GOLD_NUGGET).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(2.0f, 5.0f))))).conditionally(TableBonusLootCondition.builder(lv.getOrThrow(Enchantments.FORTUNE), 0.1f, 0.14285715f, 0.25f, 1.0f))).alternatively(ItemEntry.builder(block)))));
        ...
        this.addDrop(Blocks.AMETHYST_CLUSTER, (Block block) -> this.dropsWithSilkTouch((Block)block, ((LeafEntry.Builder)((LootPoolEntry.Builder)((Object)((LeafEntry.Builder)ItemEntry.builder(Items.AMETHYST_SHARD).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(4.0f)))).apply(ApplyBonusLootFunction.oreDrops(lv.getOrThrow(Enchantments.FORTUNE))))).conditionally(MatchToolLootCondition.builder(ItemPredicate.Builder.create().tag(ItemTags.CLUSTER_MAX_HARVESTABLES)))).alternatively((LootPoolEntry.Builder)this.applyExplosionDecay((ItemConvertible)block, ItemEntry.builder(Items.AMETHYST_SHARD).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(2.0f)))))));
    ...
    private LootTable.Builder decoratedPotDrops(Block block) {
        return LootTable.builder().pool(LootPool.builder().rolls(ConstantLootNumberProvider.create(1.0f)).with(((LeafEntry.Builder)DynamicEntry.builder(DecoratedPotBlock.SHERDS_DYNAMIC_DROP_ID).conditionally(BlockStatePropertyLootCondition.builder(block).properties(StatePredicate.Builder.create().exactMatch(DecoratedPotBlock.CRACKED, true)))).alternatively((LootPoolEntry.Builder<?>)((Object)ItemEntry.builder(block).apply(CopyComponentsLootFunction.builder(CopyComponentsLootFunction.Source.BLOCK_ENTITY).include(DataComponentTypes.POT_DECORATIONS))))));
    }
    ...
    private LootTable.Builder pitcherCropDrops() {
        return this.applyExplosionDecay(Blocks.PITCHER_CROP, LootTable.builder().pool(LootPool.builder().with(AlternativeEntry.builder(PitcherCropBlock.AGE.getValues(), age -> {
            BlockStatePropertyLootCondition.Builder lv = BlockStatePropertyLootCondition.builder(Blocks.PITCHER_CROP).properties(StatePredicate.Builder.create().exactMatch(TallPlantBlock.HALF, DoubleBlockHalf.LOWER));
            BlockStatePropertyLootCondition.Builder lv2 = BlockStatePropertyLootCondition.builder(Blocks.PITCHER_CROP).properties(StatePredicate.Builder.create().exactMatch(PitcherCropBlock.AGE, age.intValue()));
            if (age == 4) {
                return ((LeafEntry.Builder)((LeafEntry.Builder)ItemEntry.builder(Items.PITCHER_PLANT).conditionally(lv2)).conditionally(lv)).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(1.0f)));
            }
            return ((LeafEntry.Builder)((LeafEntry.Builder)ItemEntry.builder(Items.PITCHER_POD).conditionally(lv2)).conditionally(lv)).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(1.0f)));
        }))));
    }
}
