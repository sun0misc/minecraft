...
public class VanillaBlockLootTableGenerator extends BlockLootTableGenerator {
   ...
   protected void generate() {
      ...
      this.addDrop(Blocks.SCULK_VEIN, (block) -> {
         return this.multifaceGrowthDrops(block, WITH_SILK_TOUCH);
      });
      ...
      this.addDrop(Blocks.CAVE_VINES, (block) -> {
         return BlockLootTableGenerator.glowBerryDrops(block);
      });
      ...
      this.addDrop(Blocks.PLAYER_HEAD, (block) -> {
         return LootTable.builder().pool((LootPool.Builder)this.addSurvivesExplosionCondition(block, LootPool.builder().rolls(ConstantLootNumberProvider.create(1.0F)).with(ItemEntry.builder(block).apply(CopyNbtLootFunction.builder((LootNbtProvider)ContextLootNbtProvider.BLOCK_ENTITY).withOperation("SkullOwner", "SkullOwner").withOperation("note_block_sound", String.format(Locale.ROOT, "%s.%s", "BlockEntityTag", "note_block_sound"))))));
      });
      this.addDrop(Blocks.BEE_NEST, (block) -> {
         return beeNestDrops(block);
      });
      this.addDrop(Blocks.BEEHIVE, (block) -> {
         return beehiveDrops(block);
      });
      ...
      LootCondition.Builder lv = BlockStatePropertyLootCondition.builder(Blocks.BEETROOTS).properties(StatePredicate.Builder.create().exactMatch(BeetrootsBlock.AGE, 3));
      this.addDrop(Blocks.BEETROOTS, this.cropDrops(Blocks.BEETROOTS, Items.BEETROOT, Items.BEETROOT_SEEDS, lv));
      LootCondition.Builder lv2 = BlockStatePropertyLootCondition.builder(Blocks.WHEAT).properties(StatePredicate.Builder.create().exactMatch(CropBlock.AGE, 7));
      this.addDrop(Blocks.WHEAT, this.cropDrops(Blocks.WHEAT, Items.WHEAT, Items.WHEAT_SEEDS, lv2));
      LootCondition.Builder lv3 = BlockStatePropertyLootCondition.builder(Blocks.CARROTS).properties(StatePredicate.Builder.create().exactMatch(CarrotsBlock.AGE, 7));
      LootCondition.Builder lv4 = BlockStatePropertyLootCondition.builder(Blocks.MANGROVE_PROPAGULE).properties(StatePredicate.Builder.create().exactMatch(PropaguleBlock.AGE, 4));
      this.addDrop(Blocks.MANGROVE_PROPAGULE, (LootTable.Builder)this.applyExplosionDecay(Blocks.MANGROVE_PROPAGULE, LootTable.builder().pool(LootPool.builder().conditionally(lv4).with(ItemEntry.builder(Items.MANGROVE_PROPAGULE)))));
      ...
      this.addDrop(Blocks.CARROTS, (LootTable.Builder)this.applyExplosionDecay(Blocks.CARROTS, LootTable.builder().pool(LootPool.builder().with(ItemEntry.builder(Items.CARROT))).pool(LootPool.builder().conditionally(lv3).with(ItemEntry.builder(Items.CARROT).apply(ApplyBonusLootFunction.binomialWithBonusCount(Enchantments.FORTUNE, 0.5714286F, 3))))));
      LootCondition.Builder lv5 = BlockStatePropertyLootCondition.builder(Blocks.POTATOES).properties(StatePredicate.Builder.create().exactMatch(PotatoesBlock.AGE, 7));
      this.addDrop(Blocks.POTATOES, (LootTable.Builder)this.applyExplosionDecay(Blocks.POTATOES, LootTable.builder().pool(LootPool.builder().with(ItemEntry.builder(Items.POTATO))).pool(LootPool.builder().conditionally(lv5).with(ItemEntry.builder(Items.POTATO).apply(ApplyBonusLootFunction.binomialWithBonusCount(Enchantments.FORTUNE, 0.5714286F, 3)))).pool(LootPool.builder().conditionally(lv5).with(ItemEntry.builder(Items.POISONOUS_POTATO).conditionally(RandomChanceLootCondition.builder(0.02F))))));
      ...
      this.addDrop(Blocks.NETHER_GOLD_ORE, (block) -> {
         return dropsWithSilkTouch(block, (LootPoolEntry.Builder)this.applyExplosionDecay(block, ItemEntry.builder(Items.GOLD_NUGGET).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(2.0F, 6.0F))).apply(ApplyBonusLootFunction.oreDrops(Enchantments.FORTUNE))));
      });
      ...
      this.addDrop(Blocks.COBWEB, (block) -> {
         return dropsWithSilkTouchOrShears(block, (LootPoolEntry.Builder)this.addSurvivesExplosionCondition(block, ItemEntry.builder(Items.STRING)));
      });
      this.addDrop(Blocks.DEAD_BUSH, (block) -> {
         return dropsWithShears(block, (LootPoolEntry.Builder)this.applyExplosionDecay(block, ItemEntry.builder(Items.STICK).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(0.0F, 2.0F)))));
      });
      ...
      this.addDrop(Blocks.GLOW_LICHEN, (block) -> {
         return this.multifaceGrowthDrops(block, WITH_SHEARS);
      });
      ...
      this.addDrop(Blocks.LARGE_FERN, (block) -> {
         return this.tallGrassDrops(block, Blocks.FERN);
      });
      this.addDrop(Blocks.TALL_GRASS, (block) -> {
         return this.tallGrassDrops(block, Blocks.GRASS);
      });
      ...
      this.addDrop(Blocks.GRAVEL, (block) -> {
         return dropsWithSilkTouch(block, (LootPoolEntry.Builder)this.addSurvivesExplosionCondition(block, ((LeafEntry.Builder)ItemEntry.builder(Items.FLINT).conditionally(TableBonusLootCondition.builder(Enchantments.FORTUNE, 0.1F, 0.14285715F, 0.25F, 1.0F))).alternatively(ItemEntry.builder(block))));
      });
      this.addDrop(Blocks.CAMPFIRE, (block) -> {
         return dropsWithSilkTouch(block, (LootPoolEntry.Builder)this.addSurvivesExplosionCondition(block, ItemEntry.builder(Items.CHARCOAL).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(2.0F)))));
      });
      this.addDrop(Blocks.GILDED_BLACKSTONE, (block) -> {
         return dropsWithSilkTouch(block, (LootPoolEntry.Builder)this.addSurvivesExplosionCondition(block, ((LeafEntry.Builder)ItemEntry.builder(Items.GOLD_NUGGET).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(2.0F, 5.0F))).conditionally(TableBonusLootCondition.builder(Enchantments.FORTUNE, 0.1F, 0.14285715F, 0.25F, 1.0F))).alternatively(ItemEntry.builder(block))));
      });
      this.addDrop(Blocks.SOUL_CAMPFIRE, (block) -> {
         return dropsWithSilkTouch(block, (LootPoolEntry.Builder)this.addSurvivesExplosionCondition(block, ItemEntry.builder(Items.SOUL_SOIL).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(1.0F)))));
      });
      this.addDrop(Blocks.AMETHYST_CLUSTER, (block) -> {
         return dropsWithSilkTouch(block, ((LeafEntry.Builder)ItemEntry.builder(Items.AMETHYST_SHARD).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(4.0F))).apply(ApplyBonusLootFunction.oreDrops(Enchantments.FORTUNE)).conditionally(MatchToolLootCondition.builder(ItemPredicate.Builder.create().tag(ItemTags.CLUSTER_MAX_HARVESTABLES)))).alternatively((LootPoolEntry.Builder)this.applyExplosionDecay(block, ItemEntry.builder(Items.AMETHYST_SHARD).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(2.0F))))));
      });
   ...
   private LootTable.Builder decoratedPotDrops(Block block) {
      return LootTable.builder().pool(LootPool.builder().rolls(ConstantLootNumberProvider.create(1.0F)).with(((LeafEntry.Builder)((LeafEntry.Builder)DynamicEntry.builder(DecoratedPotBlock.SHARDS_NBT_KEY).conditionally(MatchToolLootCondition.builder(ItemPredicate.Builder.create().tag(ItemTags.BREAKS_DECORATED_POTS)))).conditionally(WITHOUT_SILK_TOUCH)).alternatively(ItemEntry.builder(block).apply(CopyNbtLootFunction.builder((LootNbtProvider)ContextLootNbtProvider.BLOCK_ENTITY).withOperation("shards", "BlockEntityTag.shards")))));
   }
   ...
   private LootTable.Builder pitcherCropDrops() {
      return (LootTable.Builder)this.applyExplosionDecay(Blocks.PITCHER_CROP, LootTable.builder().pool(LootPool.builder().with(AlternativeEntry.builder(PitcherCropBlock.AGE.getValues(), (age) -> {
         BlockStatePropertyLootCondition.Builder lv = BlockStatePropertyLootCondition.builder(Blocks.PITCHER_CROP).properties(StatePredicate.Builder.create().exactMatch(TallPlantBlock.HALF, (Comparable)DoubleBlockHalf.LOWER));
         BlockStatePropertyLootCondition.Builder lv2 = BlockStatePropertyLootCondition.builder(Blocks.PITCHER_CROP).properties(StatePredicate.Builder.create().exactMatch(PitcherCropBlock.AGE, age));
         return age == 4 ? ((LeafEntry.Builder)((LeafEntry.Builder)ItemEntry.builder(Items.PITCHER_PLANT).conditionally(lv2)).conditionally(lv)).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(1.0F))) : ((LeafEntry.Builder)((LeafEntry.Builder)ItemEntry.builder(Items.PITCHER_POD).conditionally(lv2)).conditionally(lv)).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(1.0F)));
      }))));
   }
