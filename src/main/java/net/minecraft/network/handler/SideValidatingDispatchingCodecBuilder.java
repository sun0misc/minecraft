...
public class SideValidatingDispatchingCodecBuilder<B extends ByteBuf, L extends PacketListener> {
    private final PacketCodecDispatcher.Builder<B, Packet<? super L>, PacketType<? extends Packet<? super L>>> backingBuilder = PacketCodecDispatcher.builder(Packet::getPacketId);
