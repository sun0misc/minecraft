...
implements Packet<ServerPlayPacketListener> {
    ...
    private static final PacketCodec<RegistryByteBuf, Int2ObjectMap<ItemStack>> STACK_MAP_CODEC = PacketCodecs.map(Int2ObjectOpenHashMap::new, PacketCodecs.SHORT.xmap(Short::intValue, Integer::shortValue), ItemStack.OPTIONAL_PACKET_CODEC, 128);
    ...
    private ClickSlotC2SPacket(RegistryByteBuf buf) {
        ...
        this.modifiedStacks = Int2ObjectMaps.unmodifiable((Int2ObjectMap)STACK_MAP_CODEC.decode(buf));
