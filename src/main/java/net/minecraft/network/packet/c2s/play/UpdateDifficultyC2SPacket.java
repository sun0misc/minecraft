...
implements Packet<ServerPlayPacketListener> {
    public static final PacketCodec<PacketByteBuf, UpdateDifficultyC2SPacket> CODEC = Packet.createCodec(UpdateDifficultyC2SPacket::write, UpdateDifficultyC2SPacket::new);
