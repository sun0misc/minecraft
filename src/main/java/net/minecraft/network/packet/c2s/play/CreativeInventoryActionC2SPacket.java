...
{
    public static final PacketCodec<RegistryByteBuf, CreativeInventoryActionC2SPacket> CODEC = PacketCodec.tuple(PacketCodecs.SHORT, CreativeInventoryActionC2SPacket::slot, ItemStack.createExtraValidatingPacketCodec(ItemStack.OPTIONAL_PACKET_CODEC), CreativeInventoryActionC2SPacket::stack, CreativeInventoryActionC2SPacket::new);
