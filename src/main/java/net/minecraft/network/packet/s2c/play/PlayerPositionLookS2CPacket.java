...
public class PlayerPositionLookS2CPacket implements Packet {
   ...
   public PlayerPositionLookS2CPacket(double x, double y, double z, float yaw, float pitch, Set flags, int teleportId) {
      this.x = x;
      this.y = y;
      this.z = z;
      this.yaw = yaw;
