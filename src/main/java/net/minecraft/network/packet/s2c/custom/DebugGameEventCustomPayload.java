...
{
    public static final PacketCodec<PacketByteBuf, DebugGameEventCustomPayload> CODEC = CustomPayload.codecOf(DebugGameEventCustomPayload::write, DebugGameEventCustomPayload::new);
