...
implements Packet<ClientPlayPacketListener> {
    public static final PacketCodec<PacketByteBuf, PlayerSpawnPositionS2CPacket> CODEC = Packet.createCodec(PlayerSpawnPositionS2CPacket::write, PlayerSpawnPositionS2CPacket::new);
