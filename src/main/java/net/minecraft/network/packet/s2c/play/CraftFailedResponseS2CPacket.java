...
implements Packet<ClientPlayPacketListener> {
    public static final PacketCodec<PacketByteBuf, CraftFailedResponseS2CPacket> CODEC = Packet.createCodec(CraftFailedResponseS2CPacket::write, CraftFailedResponseS2CPacket::new);
