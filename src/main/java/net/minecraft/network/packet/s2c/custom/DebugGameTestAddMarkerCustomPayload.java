...
{
    public static final PacketCodec<PacketByteBuf, DebugGameTestAddMarkerCustomPayload> CODEC = CustomPayload.codecOf(DebugGameTestAddMarkerCustomPayload::write, DebugGameTestAddMarkerCustomPayload::new);
