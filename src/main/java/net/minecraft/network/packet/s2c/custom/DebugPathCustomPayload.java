...
{
    public static final PacketCodec<PacketByteBuf, DebugPathCustomPayload> CODEC = CustomPayload.codecOf(DebugPathCustomPayload::write, DebugPathCustomPayload::new);
