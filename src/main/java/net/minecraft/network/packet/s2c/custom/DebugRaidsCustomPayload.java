...
{
    public static final PacketCodec<PacketByteBuf, DebugRaidsCustomPayload> CODEC = CustomPayload.codecOf(DebugRaidsCustomPayload::write, DebugRaidsCustomPayload::new);
