...
implements Packet<ClientPlayPacketListener> {
    public static final PacketCodec<RegistryByteBuf, SynchronizeRecipesS2CPacket> CODEC = PacketCodec.tuple(RecipeEntry.PACKET_CODEC.collect(PacketCodecs.toList()), packet -> packet.recipes, SynchronizeRecipesS2CPacket::new);
