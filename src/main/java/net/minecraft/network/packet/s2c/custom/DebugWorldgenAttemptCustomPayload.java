...
{
    public static final PacketCodec<PacketByteBuf, DebugWorldgenAttemptCustomPayload> CODEC = CustomPayload.codecOf(DebugWorldgenAttemptCustomPayload::write, DebugWorldgenAttemptCustomPayload::new);
