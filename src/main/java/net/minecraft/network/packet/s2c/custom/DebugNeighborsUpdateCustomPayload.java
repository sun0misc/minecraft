...
{
    public static final PacketCodec<PacketByteBuf, DebugNeighborsUpdateCustomPayload> CODEC = CustomPayload.codecOf(DebugNeighborsUpdateCustomPayload::write, DebugNeighborsUpdateCustomPayload::new);
