...
{
    public static final PacketCodec<PacketByteBuf, DebugPoiTicketCountCustomPayload> CODEC = CustomPayload.codecOf(DebugPoiTicketCountCustomPayload::write, DebugPoiTicketCountCustomPayload::new);
