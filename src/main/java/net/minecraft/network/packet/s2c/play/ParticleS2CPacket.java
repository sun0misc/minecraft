...
public class ParticleS2CPacket implements Packet {
   ...
   public ParticleS2CPacket(ParticleEffect parameters, boolean longDistance, double x, double y, double z, float offsetX, float offsetY, float offsetZ, float speed, int count) {
   ...
   public ParticleS2CPacket(PacketByteBuf buf) {
      ParticleType lv = (ParticleType)buf.readRegistryValue(Registries.PARTICLE_TYPE);
   ...
   private ParticleEffect readParticleParameters(PacketByteBuf buf, ParticleType type) {
