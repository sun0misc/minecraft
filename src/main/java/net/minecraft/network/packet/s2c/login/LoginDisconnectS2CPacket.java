...
implements Packet<ClientLoginPacketListener> {
    public static final PacketCodec<PacketByteBuf, LoginDisconnectS2CPacket> CODEC = Packet.createCodec(LoginDisconnectS2CPacket::write, LoginDisconnectS2CPacket::new);
