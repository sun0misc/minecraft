...
{
    public static final PacketCodec<PacketByteBuf, DebugVillageSectionsCustomPayload> CODEC = CustomPayload.codecOf(DebugVillageSectionsCustomPayload::write, DebugVillageSectionsCustomPayload::new);
