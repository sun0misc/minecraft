...
{
    public static final PacketCodec<PacketByteBuf, DebugPoiAddedCustomPayload> CODEC = CustomPayload.codecOf(DebugPoiAddedCustomPayload::write, DebugPoiAddedCustomPayload::new);
