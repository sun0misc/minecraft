...
{
    public static final PacketCodec<PacketByteBuf, DebugStructuresCustomPayload> CODEC = CustomPayload.codecOf(DebugStructuresCustomPayload::write, DebugStructuresCustomPayload::new);
