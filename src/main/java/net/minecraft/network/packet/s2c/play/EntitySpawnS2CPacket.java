...
public class EntitySpawnS2CPacket implements Packet {
   ...
   public EntitySpawnS2CPacket(Entity entity, int entityData) {
      this(entity.getId(), entity.getUuid(), entity.getX(), entity.getY(), entity.getZ(), entity.getPitch(), entity.getYaw(), entity.getType(), entityData, entity.getVelocity(), (double)entity.getHeadYaw());
   }
   ...
   public EntitySpawnS2CPacket(PacketByteBuf buf) {
      ...
      this.entityType = (EntityType)buf.readRegistryValue(Registries.ENTITY_TYPE);
