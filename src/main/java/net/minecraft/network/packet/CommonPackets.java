...
public class CommonPackets {
    ...
    public static final PacketType<class_9814> CUSTOM_REPORT_DETAILS = CommonPackets.s2c("custom_report_details");
    ...
    public static final PacketType<class_9815> SERVER_LINKS = CommonPackets.s2c("server_links");
