...
public class ConsumeItemCriterion extends AbstractCriterion {
   ...
   public static class Conditions extends AbstractCriterionConditions {
      ...
      public static Conditions item(ItemConvertible item) {
         return new Conditions(EntityPredicate.Extended.EMPTY, new ItemPredicate((TagKey)null, ImmutableSet.of(item.asItem()), NumberRange.IntRange.ANY, NumberRange.IntRange.ANY, EnchantmentPredicate.ARRAY_OF_ANY, EnchantmentPredicate.ARRAY_OF_ANY, (Potion)null, NbtPredicate.ANY));
      }
