...
public class AdvancementDisplay {
   ...
   public static AdvancementDisplay fromJson(JsonObject obj) {
      Text lv = Text.Serializer.fromJson(obj.get("title"));
      Text lv2 = Text.Serializer.fromJson(obj.get("description"));
      if (lv != null && lv2 != null) {
         ItemStack lv3 = iconFromJson(JsonHelper.getObject(obj, "icon"));
   ...
   public static AdvancementDisplay fromPacket(PacketByteBuf buf) {
      ...
      AdvancementFrame lv4 = (AdvancementFrame)buf.readEnumConstant(AdvancementFrame.class);
      int i = buf.readInt();
