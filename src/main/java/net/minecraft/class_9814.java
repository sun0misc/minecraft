...
public record class_9814(Map<String, String> details) implements Packet<ClientCommonPacketListener>
{
    ...
    private static final PacketCodec<ByteBuf, Map<String, String>> field_52189 = PacketCodecs.map(HashMap::new, PacketCodecs.string(128), PacketCodecs.string(4096), 32);
