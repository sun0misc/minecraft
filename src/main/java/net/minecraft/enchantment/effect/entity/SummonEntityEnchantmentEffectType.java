...
{
    public static final MapCodec<SummonEntityEnchantmentEffectType> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(((MapCodec)RegistryCodecs.entryList(RegistryKeys.ENTITY_TYPE).fieldOf("entity")).forGetter(SummonEntityEnchantmentEffectType::entityTypes), Codec.BOOL.optionalFieldOf("join_team", false).forGetter(SummonEntityEnchantmentEffectType::joinTeam)).apply((Applicative<SummonEntityEnchantmentEffectType, ?>)instance, SummonEntityEnchantmentEffectType::new));
