...
public interface EnchantmentEntityEffectType
extends EnchantmentLocationBasedEffectType {
    public static final Codec<EnchantmentEntityEffectType> CODEC = Registries.ENCHANTMENT_ENTITY_EFFECT_TYPE.getCodec().dispatch(EnchantmentEntityEffectType::getCodec, Function.identity());

    public static MapCodec<? extends EnchantmentEntityEffectType> registerAndGetDefault(Registry<MapCodec<? extends EnchantmentEntityEffectType>> registry) {
