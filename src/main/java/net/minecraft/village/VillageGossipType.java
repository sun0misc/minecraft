...
public enum VillageGossipType implements StringIdentifiable {
   ...
   public static final com.mojang.serialization.Codec CODEC = StringIdentifiable.createCodec(VillageGossipType::values);
   ...
   // $FF: synthetic method
   private static VillageGossipType[] method_36623() {
