...
public class GameTestState {
   ...
   public Vec3i getSize() {
      ...
      return lv == null ? null : lv.getSize();
   }

   @Nullable
   public Box getBoundingBox() {
      StructureBlockBlockEntity lv = this.getStructureBlockBlockEntity();
      return lv == null ? null : StructureTestUtil.getStructureBoundingBox(lv);
   }
   ...
   public void clearArea() {
      if (this.structureBlockEntity == null) {
         ...
         BlockBox lv = StructureTestUtil.getStructureBlockBox(this.structureBlockEntity);
         StructureTestUtil.clearArea(lv, this.pos.getY(), this.world);
      }
   }
