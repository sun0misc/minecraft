      ...
      if (!world.isClient) {
         ...
         for(int i = 0; i < 16; ++i) {
            ...
            if (user.teleport(g, h, j, true)) {
               world.emitGameEvent(GameEvent.TELEPORT, lv2, GameEvent.Emitter.of((Entity)user));
               SoundEvent lv3 = user instanceof FoxEntity ? SoundEvents.ENTITY_FOX_TELEPORT : SoundEvents.ITEM_CHORUS_FRUIT_TELEPORT;
               world.playSound((PlayerEntity)null, d, e, f, lv3, SoundCategory.PLAYERS, 1.0F, 1.0F);
