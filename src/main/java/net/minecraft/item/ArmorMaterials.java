...
public class ArmorMaterials {
    ...
    }), 15, SoundEvents.ITEM_ARMOR_EQUIP_LEATHER, 0.0f, 0.0f, () -> Ingredient.ofItems(Items.LEATHER), List.of(new ArmorMaterial.Layer(Identifier.method_60656("leather"), "", true), new ArmorMaterial.Layer(Identifier.method_60656("leather"), "_overlay", false)));
    ...
    private static RegistryEntry<ArmorMaterial> register(String id, EnumMap<ArmorItem.Type, Integer> defense, int enchantability, RegistryEntry<SoundEvent> equipSound, float toughness, float knockbackResistance, Supplier<Ingredient> repairIngredient, List<ArmorMaterial.Layer> layers) {
        ...
        return Registry.registerReference(Registries.ARMOR_MATERIAL, Identifier.method_60656(id), new ArmorMaterial(enumMap2, enchantability, equipSound, repairIngredient, layers, toughness, knockbackResistance));
    }
}
