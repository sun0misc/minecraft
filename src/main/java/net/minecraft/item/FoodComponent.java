...
public class FoodComponent {
   ...
   private final List statusEffects;

   FoodComponent(int hunger, float saturationModifier, boolean meat, boolean alwaysEdible, boolean snack, List statusEffects) {
      this.hunger = hunger;
   ...
   public static class Builder {
      ...
      private final List statusEffects = Lists.newArrayList();
