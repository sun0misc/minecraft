...
public record ArmorTrimMaterial(String assetName, RegistryEntry<Item> ingredient, float itemModelIndex, Map<RegistryEntry<ArmorMaterial>, String> overrideArmorMaterials, Text description) {
    public static final Codec<ArmorTrimMaterial> CODEC = RecordCodecBuilder.create(instance -> instance.group(((MapCodec)Codecs.IDENTIFIER_PATH.fieldOf("asset_name")).forGetter(ArmorTrimMaterial::assetName), ((MapCodec)RegistryFixedCodec.of(RegistryKeys.ITEM).fieldOf("ingredient")).forGetter(ArmorTrimMaterial::ingredient), ((MapCodec)Codec.FLOAT.fieldOf("item_model_index")).forGetter(ArmorTrimMaterial::itemModelIndex), Codec.unboundedMap(ArmorMaterial.CODEC, Codec.STRING).optionalFieldOf("override_armor_materials", Map.of()).forGetter(ArmorTrimMaterial::overrideArmorMaterials), ((MapCodec)TextCodecs.CODEC.fieldOf("description")).forGetter(ArmorTrimMaterial::description)).apply((Applicative<ArmorTrimMaterial, ?>)instance, ArmorTrimMaterial::new));
    public static final PacketCodec<RegistryByteBuf, ArmorTrimMaterial> PACKET_CODEC = PacketCodec.tuple(PacketCodecs.STRING, ArmorTrimMaterial::assetName, PacketCodecs.registryEntry(RegistryKeys.ITEM), ArmorTrimMaterial::ingredient, PacketCodecs.FLOAT, ArmorTrimMaterial::itemModelIndex, PacketCodecs.map(Object2ObjectOpenHashMap::new, PacketCodecs.registryEntry(RegistryKeys.ARMOR_MATERIAL), PacketCodecs.STRING), ArmorTrimMaterial::overrideArmorMaterials, TextCodecs.REGISTRY_PACKET_CODEC, ArmorTrimMaterial::description, ArmorTrimMaterial::new);
    ...
    public static ArmorTrimMaterial of(String assetName, Item ingredient, float itemModelIndex, Text description, Map<RegistryEntry<ArmorMaterial>, String> overrideArmorMaterials) {
