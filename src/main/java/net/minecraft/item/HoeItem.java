...
extends MiningToolItem {
    ...
    public ActionResult useOnBlock(ItemUsageContext context) {
        ...
        Pair<Predicate<ItemUsageContext>, Consumer<ItemUsageContext>> pair = TILLING_ACTIONS.get(lv.getBlockState(lv2 = context.getBlockPos()).getBlock());
        if (pair == null) {
        ...
        if (predicate.test(context)) {
            ...
            if (!lv.isClient) {
                ...
                if (lv3 != null) {
                    context.getStack().damage(1, lv3, LivingEntity.getSlotForHand(context.getHand()));
                }
            }
