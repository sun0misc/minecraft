...
public class MapDecorationTypes {
    ...
    private static RegistryEntry<MapDecorationType> register(String id, String assetId, boolean showOnItemFrame, int mapColor, boolean trackCount, boolean explorationMapElement) {
        RegistryKey<MapDecorationType> lv = RegistryKey.of(RegistryKeys.MAP_DECORATION_TYPE, Identifier.method_60656(id));
        MapDecorationType lv2 = new MapDecorationType(Identifier.method_60656(assetId), showOnItemFrame, mapColor, explorationMapElement, trackCount);
