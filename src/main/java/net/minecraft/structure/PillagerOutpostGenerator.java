...
public class PillagerOutpostGenerator {
   public static final RegistryKey STRUCTURE_POOLS = StructurePools.of("pillager_outpost/base_plates");
   ...
   public static void bootstrap(Registerable poolRegisterable) {
      ...
      RegistryEntry lv2 = lv.getOrThrow(StructureProcessorLists.OUTPOST_ROT);
