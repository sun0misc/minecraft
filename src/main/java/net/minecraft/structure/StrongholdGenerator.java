...
public class StrongholdGenerator {
    ...
    private static Piece createPiece(Class<? extends Piece> pieceType, StructurePiecesHolder holder, Random random, int x, int y, int z, @Nullable Direction orientation, int chainLength) {
        ...
        if (pieceType == Corridor.class) {
            lv = Corridor.create(holder, random, x, y, z, orientation, chainLength);
        } else if (pieceType == PrisonHall.class) {
            lv = PrisonHall.create(holder, random, x, y, z, orientation, chainLength);
        } else if (pieceType == LeftTurn.class) {
            lv = LeftTurn.create(holder, random, x, y, z, orientation, chainLength);
        } else if (pieceType == RightTurn.class) {
            lv = RightTurn.create(holder, random, x, y, z, orientation, chainLength);
        } else if (pieceType == SquareRoom.class) {
            lv = SquareRoom.create(holder, random, x, y, z, orientation, chainLength);
        } else if (pieceType == Stairs.class) {
            lv = Stairs.create(holder, random, x, y, z, orientation, chainLength);
        } else if (pieceType == SpiralStaircase.class) {
            lv = SpiralStaircase.create(holder, random, x, y, z, orientation, chainLength);
        } else if (pieceType == FiveWayCrossing.class) {
            lv = FiveWayCrossing.create(holder, random, x, y, z, orientation, chainLength);
        } else if (pieceType == ChestCorridor.class) {
            lv = ChestCorridor.create(holder, random, x, y, z, orientation, chainLength);
        } else if (pieceType == Library.class) {
            lv = Library.create(holder, random, x, y, z, orientation, chainLength);
        } else if (pieceType == PortalRoom.class) {
            lv = PortalRoom.create(holder, x, y, z, orientation, chainLength);
        }
        return lv;
    }
    ...
    private static Piece pickPiece(Start start, StructurePiecesHolder holder, Random random, int x, int y, int z, Direction orientation, int chainLength) {
        ...
        if (activePieceType != null) {
            Piece lv = StrongholdGenerator.createPiece(activePieceType, holder, random, x, y, z, orientation, chainLength);
            activePieceType = null;
            if (lv != null) {
                return lv;
            }
        ...
        block0: while (m < 5) {
            ...
            for (PieceData lv2 : possiblePieces) {
                if ((n -= lv2.weight) >= 0) continue;
                if (!lv2.canGenerate(chainLength) || lv2 == start.lastPiece) continue block0;
                Piece lv3 = StrongholdGenerator.createPiece(lv2.pieceType, holder, random, x, y, z, orientation, chainLength);
        ...
        BlockBox lv4 = SmallCorridor.create(holder, random, x, y, z, orientation);
    ...
    static StructurePiece pieceGenerator(Start start, StructurePiecesHolder holder, Random random, int x, int y, int z, @Nullable Direction orientation, int chainLength) {
        ...
        Piece lv = StrongholdGenerator.pickPiece(start, holder, random, x, y, z, orientation, chainLength + 1);
        if (lv != null) {
            holder.addPiece(lv);
            start.pieces.add(lv);
        }
    ...
    extends Piece {
        ...
        public static Corridor create(StructurePiecesHolder holder, Random random, int x, int y, int z, Direction orientation, int chainLength) {
            ...
            if (!Corridor.isInBounds(lv) || holder.getIntersecting(lv) != null) {
                return null;
            }
            return new Corridor(chainLength, random, lv, orientation);
        }
    ...
    extends Piece {
        ...
        public static PrisonHall create(StructurePiecesHolder holder, Random random, int x, int y, int z, Direction orientation, int chainLength) {
            ...
            if (!PrisonHall.isInBounds(lv) || holder.getIntersecting(lv) != null) {
                return null;
            }
            return new PrisonHall(chainLength, random, lv, orientation);
        }
    ...
    extends Turn {
        ...
        public static LeftTurn create(StructurePiecesHolder holder, Random random, int x, int y, int z, Direction orientation, int chainLength) {
            ...
            if (!LeftTurn.isInBounds(lv) || holder.getIntersecting(lv) != null) {
                return null;
            }
            return new LeftTurn(chainLength, random, lv, orientation);
        }
    ...
    extends Turn {
        ...
        public static RightTurn create(StructurePiecesHolder holder, Random random, int x, int y, int z, Direction orientation, int chainLength) {
            BlockBox lv = BlockBox.rotated(x, y, z, -1, -1, 0, 5, 5, 5, orientation);
            if (!RightTurn.isInBounds(lv) || holder.getIntersecting(lv) != null) {
                return null;
            }
            return new RightTurn(chainLength, random, lv, orientation);
        }
    ...
    extends Piece {
        ...
        public static SquareRoom create(StructurePiecesHolder holder, Random random, int x, int y, int z, Direction orientation, int chainLength) {
            ...
            if (!SquareRoom.isInBounds(lv) || holder.getIntersecting(lv) != null) {
                return null;
            }
            return new SquareRoom(chainLength, random, lv, orientation);
        }
    ...
    extends Piece {
        ...
        public static Stairs create(StructurePiecesHolder holder, Random random, int x, int y, int z, Direction orientation, int chainLength) {
            ...
            if (!Stairs.isInBounds(lv) || holder.getIntersecting(lv) != null) {
                return null;
            }
            return new Stairs(chainLength, random, lv, orientation);
        }
    ...
    extends Piece {
        ...
        public static SpiralStaircase create(StructurePiecesHolder holder, Random random, int x, int y, int z, Direction orientation, int chainLength) {
            ...
            if (!SpiralStaircase.isInBounds(lv) || holder.getIntersecting(lv) != null) {
                return null;
            }
            return new SpiralStaircase(chainLength, random, lv, orientation);
        }
    ...
    extends Piece {
        ...
        public static FiveWayCrossing create(StructurePiecesHolder holder, Random random, int x, int y, int z, Direction orientation, int chainLength) {
            ...
            if (!FiveWayCrossing.isInBounds(lv) || holder.getIntersecting(lv) != null) {
                return null;
            }
            return new FiveWayCrossing(chainLength, random, lv, orientation);
        }
    ...
    extends Piece {
        ...
        public static ChestCorridor create(StructurePiecesHolder holder, Random random, int x, int y, int z, Direction orientation, int chainlength) {
            BlockBox lv = BlockBox.rotated(x, y, z, -1, -1, 0, 5, 5, 7, orientation);
            if (!ChestCorridor.isInBounds(lv) || holder.getIntersecting(lv) != null) {
                return null;
            }
            return new ChestCorridor(chainlength, random, lv, orientation);
        }
    ...
    extends Piece {
        ...
        public static Library create(StructurePiecesHolder holder, Random random, int x, int y, int z, Direction orientation, int chainLength) {
            ...
            if (!(Library.isInBounds(lv) && holder.getIntersecting(lv) == null || Library.isInBounds(lv = BlockBox.rotated(x, y, z, -4, -1, 0, 14, 6, 15, orientation)) && holder.getIntersecting(lv) == null)) {
                return null;
            }
    ...
    extends Piece {
        ...
        public static PortalRoom create(StructurePiecesHolder holder, int x, int y, int z, Direction orientation, int chainLength) {
            ...
            if (!PortalRoom.isInBounds(lv) || holder.getIntersecting(lv) != null) {
                return null;
            }
            return new PortalRoom(chainLength, lv, orientation);
        }

        @Override
        public void generate(StructureWorldAccess world, StructureAccessor structureAccessor, ChunkGenerator chunkGenerator, Random random, BlockBox chunkBox, ChunkPos chunkPos, BlockPos pivot) {
            BlockPos.Mutable lv9;
            int j;
            ...
            if (!this.spawnerPlaced && chunkBox.contains(lv9 = this.offsetPos(5, 3, 6))) {
