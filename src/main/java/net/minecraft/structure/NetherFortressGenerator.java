...
public class NetherFortressGenerator {
   ...
   static Piece createPiece(PieceData pieceData, StructurePiecesHolder holder, Random random, int x, int y, int z, Direction orientation, int chainLength) {
      ...
      if (class_ == Bridge.class) {
         lv = NetherFortressGenerator.Bridge.create(holder, random, x, y, z, orientation, chainLength);
      } else if (class_ == BridgeCrossing.class) {
         lv = NetherFortressGenerator.BridgeCrossing.create(holder, x, y, z, orientation, chainLength);
      } else if (class_ == BridgeSmallCrossing.class) {
         lv = NetherFortressGenerator.BridgeSmallCrossing.create(holder, x, y, z, orientation, chainLength);
      } else if (class_ == BridgeStairs.class) {
         lv = NetherFortressGenerator.BridgeStairs.create(holder, x, y, z, chainLength, orientation);
      } else if (class_ == BridgePlatform.class) {
         lv = NetherFortressGenerator.BridgePlatform.create(holder, x, y, z, chainLength, orientation);
      } else if (class_ == CorridorExit.class) {
         lv = NetherFortressGenerator.CorridorExit.create(holder, random, x, y, z, orientation, chainLength);
      } else if (class_ == SmallCorridor.class) {
         lv = NetherFortressGenerator.SmallCorridor.create(holder, x, y, z, orientation, chainLength);
      } else if (class_ == CorridorRightTurn.class) {
         lv = NetherFortressGenerator.CorridorRightTurn.create(holder, random, x, y, z, orientation, chainLength);
      } else if (class_ == CorridorLeftTurn.class) {
         lv = NetherFortressGenerator.CorridorLeftTurn.create(holder, random, x, y, z, orientation, chainLength);
      } else if (class_ == CorridorStairs.class) {
         lv = NetherFortressGenerator.CorridorStairs.create(holder, x, y, z, orientation, chainLength);
      } else if (class_ == CorridorBalcony.class) {
         lv = NetherFortressGenerator.CorridorBalcony.create(holder, x, y, z, orientation, chainLength);
      } else if (class_ == CorridorCrossing.class) {
         lv = NetherFortressGenerator.CorridorCrossing.create(holder, x, y, z, orientation, chainLength);
      } else if (class_ == CorridorNetherWartsRoom.class) {
         lv = NetherFortressGenerator.CorridorNetherWartsRoom.create(holder, x, y, z, orientation, chainLength);
      }
   ...
   public static class Bridge extends Piece {
      ...
      public static Bridge create(StructurePiecesHolder holder, Random random, int x, int y, int z, Direction orientation, int chainLength) {
         ...
         return isInBounds(lv) && holder.getIntersecting(lv) == null ? new Bridge(chainLength, random, lv, orientation) : null;
      }
   ...
   public static class BridgeCrossing extends Piece {
      ...
      public static BridgeCrossing create(StructurePiecesHolder holder, int x, int y, int z, Direction orientation, int chainLength) {
         ...
         return isInBounds(lv) && holder.getIntersecting(lv) == null ? new BridgeCrossing(chainLength, lv, orientation) : null;
      }
   ...
   public static class BridgeSmallCrossing extends Piece {
      ...
      public static BridgeSmallCrossing create(StructurePiecesHolder holder, int x, int y, int z, Direction orientation, int chainLength) {
         ...
         return isInBounds(lv) && holder.getIntersecting(lv) == null ? new BridgeSmallCrossing(chainLength, lv, orientation) : null;
      }
   ...
   public static class BridgeStairs extends Piece {
      ...
      public static BridgeStairs create(StructurePiecesHolder holder, int x, int y, int z, int chainlength, Direction orientation) {
         ...
         return isInBounds(lv) && holder.getIntersecting(lv) == null ? new BridgeStairs(chainlength, lv, orientation) : null;
      }
   ...
   public static class BridgePlatform extends Piece {
      ...
      public static BridgePlatform create(StructurePiecesHolder holder, int x, int y, int z, int chainLength, Direction orientation) {
         ...
         return isInBounds(lv) && holder.getIntersecting(lv) == null ? new BridgePlatform(chainLength, lv, orientation) : null;
      }
      ...
      public void generate(StructureWorldAccess world, StructureAccessor structureAccessor, ChunkGenerator chunkGenerator, Random random, BlockBox chunkBox, ChunkPos chunkPos, BlockPos pivot) {
         ...
         if (!this.hasBlazeSpawner) {
            BlockPos lv3 = this.offsetPos(3, 5, 5);
   ...
   public static class CorridorExit extends Piece {
      ...
      public static CorridorExit create(StructurePiecesHolder holder, Random random, int x, int y, int z, Direction orientation, int chainLength) {
         ...
         return isInBounds(lv) && holder.getIntersecting(lv) == null ? new CorridorExit(chainLength, random, lv, orientation) : null;
      }
   ...
   public static class SmallCorridor extends Piece {
      ...
      public static SmallCorridor create(StructurePiecesHolder holder, int x, int y, int z, Direction orientation, int chainLength) {
         ...
         return isInBounds(lv) && holder.getIntersecting(lv) == null ? new SmallCorridor(chainLength, lv, orientation) : null;
      }
   ...
   public static class CorridorRightTurn extends Piece {
      ...
      public static CorridorRightTurn create(StructurePiecesHolder holder, Random random, int x, int y, int z, Direction orientation, int chainLength) {
         BlockBox lv = BlockBox.rotated(x, y, z, -1, 0, 0, 5, 7, 5, orientation);
         return isInBounds(lv) && holder.getIntersecting(lv) == null ? new CorridorRightTurn(chainLength, random, lv, orientation) : null;
      }
   ...
   public static class CorridorLeftTurn extends Piece {
      ...
      public static CorridorLeftTurn create(StructurePiecesHolder holder, Random random, int x, int y, int z, Direction orientation, int chainLength) {
         BlockBox lv = BlockBox.rotated(x, y, z, -1, 0, 0, 5, 7, 5, orientation);
         return isInBounds(lv) && holder.getIntersecting(lv) == null ? new CorridorLeftTurn(chainLength, random, lv, orientation) : null;
      }
   ...
   public static class CorridorStairs extends Piece {
      ...
      public static CorridorStairs create(StructurePiecesHolder holder, int x, int y, int z, Direction orientation, int chainLength) {
         ...
         return isInBounds(lv) && holder.getIntersecting(lv) == null ? new CorridorStairs(chainLength, lv, orientation) : null;
      }
      ...
      public void generate(StructureWorldAccess world, StructureAccessor structureAccessor, ChunkGenerator chunkGenerator, Random random, BlockBox chunkBox, ChunkPos chunkPos, BlockPos pivot) {
         ...
         for(int i = 0; i <= 9; ++i) {
            ...
            if (i <= 6) {
               this.addBlock(world, lv, 1, j + 1, i, chunkBox);
               this.addBlock(world, lv, 2, j + 1, i, chunkBox);
               this.addBlock(world, lv, 3, j + 1, i, chunkBox);
            }
            ...
            if ((i & 1) == 0) {
               this.fillWithOutline(world, chunkBox, 0, j + 2, i, 0, j + 3, i, lv2, lv2, false);
               this.fillWithOutline(world, chunkBox, 4, j + 2, i, 4, j + 3, i, lv2, lv2, false);
            }
   ...
   public static class CorridorBalcony extends Piece {
      ...
      public static CorridorBalcony create(StructurePiecesHolder holder, int x, int y, int z, Direction orientation, int chainLength) {
         ...
         return isInBounds(lv) && holder.getIntersecting(lv) == null ? new CorridorBalcony(chainLength, lv, orientation) : null;
      }
   ...
   public static class CorridorCrossing extends Piece {
      ...
      public static CorridorCrossing create(StructurePiecesHolder holder, int x, int y, int z, Direction orientation, int chainLength) {
         BlockBox lv = BlockBox.rotated(x, y, z, -1, 0, 0, 5, 7, 5, orientation);
         return isInBounds(lv) && holder.getIntersecting(lv) == null ? new CorridorCrossing(chainLength, lv, orientation) : null;
      }
   ...
   public static class CorridorNetherWartsRoom extends Piece {
      ...
      public static CorridorNetherWartsRoom create(StructurePiecesHolder holder, int x, int y, int z, Direction orientation, int chainlength) {
         BlockBox lv = BlockBox.rotated(x, y, z, -5, -3, 0, 13, 14, 13, orientation);
         return isInBounds(lv) && holder.getIntersecting(lv) == null ? new CorridorNetherWartsRoom(chainlength, lv, orientation) : null;
      }
   ...
   public static class BridgeEnd extends Piece {
      ...
      public static BridgeEnd create(StructurePiecesHolder holder, Random random, int x, int y, int z, Direction orientation, int chainLength) {
         ...
         return isInBounds(lv) && holder.getIntersecting(lv) == null ? new BridgeEnd(chainLength, random, lv, orientation) : null;
      }
      ...
      public void generate(StructureWorldAccess world, StructureAccessor structureAccessor, ChunkGenerator chunkGenerator, Random random, BlockBox chunkBox, ChunkPos chunkPos, BlockPos pivot) {
         Random lv = Random.create((long)this.seed);
   ...
   private abstract static class Piece extends StructurePiece {
      ...
      private int checkRemainingPieces(List possiblePieces) {
         ...
         PieceData lv;
         for(Iterator var4 = possiblePieces.iterator(); var4.hasNext(); i += lv.weight) {
            lv = (PieceData)var4.next();
      ...
      private Piece pickPiece(Start start, List possiblePieces, StructurePiecesHolder holder, Random random, int x, int y, int z, Direction orientation, int chainLength) {
         ...
         while(n < 5 && bl) {
            ...
            while(var14.hasNext()) {
               PieceData lv = (PieceData)var14.next();
               o -= lv.weight;
               if (o < 0) {
                  if (!lv.canGenerate(chainLength) || lv == start.lastPiece && !lv.repeatable) {
                     break;
                  }
      ...
      private StructurePiece pieceGenerator(Start start, StructurePiecesHolder holder, Random random, int x, int y, int z, @Nullable Direction orientation, int chainLength, boolean inside) {
         if (Math.abs(x - start.getBoundingBox().getMinX()) <= 112 && Math.abs(z - start.getBoundingBox().getMinZ()) <= 112) {
            ...
            StructurePiece lv = this.pickPiece(start, list, holder, random, x, y, z, orientation, chainLength + 1);
            if (lv != null) {
               holder.addPiece(lv);
               start.pieces.add(lv);
            }
