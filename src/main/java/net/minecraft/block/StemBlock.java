        ...
        if (random.nextInt((int)(25.0f / f) + 1) == 0) {
            ...
            if (i < 7) {
                ...
                if (world.getBlockState(lv2).isAir() && (lv3.isOf(Blocks.FARMLAND) || lv3.isIn(BlockTags.DIRT))) {
                    Registry<Block> lv4 = world.getRegistryManager().get(RegistryKeys.BLOCK);
                    Optional<Block> optional = lv4.getOrEmpty(this.gourdBlock);
                    Optional<Block> optional2 = lv4.getOrEmpty(this.attachedStemBlock);
