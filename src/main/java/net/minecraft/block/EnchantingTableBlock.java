...
extends BlockWithEntity {
    ...
    public void randomDisplayTick(BlockState state, World world, BlockPos pos, Random random) {
        ...
        for (BlockPos lv : POWER_PROVIDER_OFFSETS) {
            ...
            world.addParticle(ParticleTypes.ENCHANT, (double)pos.getX() + 0.5, (double)pos.getY() + 2.0, (double)pos.getZ() + 0.5, (double)((float)lv.getX() + random.nextFloat()) - 0.5, (float)lv.getY() - random.nextFloat() - 1.0f, (double)((float)lv.getZ() + random.nextFloat()) - 0.5);
        }
    }
    ...
    protected NamedScreenHandlerFactory createScreenHandlerFactory(BlockState state, World world, BlockPos pos) {
        ...
        if (lv instanceof EnchantingTableBlockEntity) {
            ...
            return new SimpleNamedScreenHandlerFactory((syncId, inventory, player) -> new EnchantmentScreenHandler(syncId, inventory, ScreenHandlerContext.create(world, pos)), lv2);
        }
        return null;
    }
