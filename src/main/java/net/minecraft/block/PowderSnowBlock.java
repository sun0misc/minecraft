...
implements FluidDrainable {
        ...
        if (!(entity instanceof LivingEntity) || entity.getBlockStateAtPos().isOf(this)) {
            ...
            if (world.isClient) {
                ...
                if (bl && lv.nextBoolean()) {
                    world.addParticle(ParticleTypes.SNOWFLAKE, entity.getX(), pos.getY() + 1, entity.getZ(), MathHelper.nextBetween(lv, -1.0f, 1.0f) * 0.083333336f, 0.05f, MathHelper.nextBetween(lv, -1.0f, 1.0f) * 0.083333336f);
                }
            }
        }
    ...
    protected VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context) {
        ...
        Entity lv2;
        if (context instanceof EntityShapeContext && (lv2 = (lv = (EntityShapeContext)context).getEntity()) != null) {
