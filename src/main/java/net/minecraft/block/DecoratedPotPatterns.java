...
public class DecoratedPotPatterns {
   ...
   private static final Map SHARD_TO_PATTERN;
   ...
   @Nullable
   public static RegistryKey fromShard(Item shard) {
      return (RegistryKey)SHARD_TO_PATTERN.get(shard);
   }
   ...
   static {
      SHARD_TO_PATTERN = Map.ofEntries(Map.entry(Items.BRICK, DECORATED_POT_SIDE_KEY), Map.entry(Items.ANGLER_POTTERY_SHARD, ANGLER_POTTERY_PATTERN_KEY), Map.entry(Items.ARCHER_POTTERY_SHARD, ARCHER_POTTERY_PATTERN_KEY), Map.entry(Items.ARMS_UP_POTTERY_SHARD, ARMS_UP_POTTERY_PATTERN_KEY), Map.entry(Items.BLADE_POTTERY_SHARD, BLADE_POTTERY_PATTERN_KEY), Map.entry(Items.BREWER_POTTERY_SHARD, BREWER_POTTERY_PATTERN_KEY), Map.entry(Items.BURN_POTTERY_SHARD, BURN_POTTERY_PATTERN_KEY), Map.entry(Items.DANGER_POTTERY_SHARD, DANGER_POTTERY_PATTERN_KEY), Map.entry(Items.EXPLORER_POTTERY_SHARD, EXPLORER_POTTERY_PATTERN_KEY), Map.entry(Items.FRIEND_POTTERY_SHARD, FRIEND_POTTERY_PATTERN_KEY), Map.entry(Items.HEART_POTTERY_SHARD, HEART_POTTERY_PATTERN_KEY), Map.entry(Items.HEARTBREAK_POTTERY_SHARD, HEARTBREAK_POTTERY_PATTERN_KEY), Map.entry(Items.HOWL_POTTERY_SHARD, HOWL_POTTERY_PATTERN_KEY), Map.entry(Items.MINER_POTTERY_SHARD, MINER_POTTERY_PATTERN_KEY), Map.entry(Items.MOURNER_POTTERY_SHARD, MOURNER_POTTERY_PATTERN_KEY), Map.entry(Items.PLENTY_POTTERY_SHARD, PLENTY_POTTERY_PATTERN_KEY), Map.entry(Items.PRIZE_POTTERY_SHARD, POTTERY_PATTERN_PRIZE_KEY), Map.entry(Items.SHEAF_POTTERY_SHARD, SHEAF_POTTERY_PATTERN_KEY), Map.entry(Items.SHELTER_POTTERY_SHARD, SHELTER_POTTERY_PATTERN_KEY), Map.entry(Items.SKULL_POTTERY_SHARD, SKULL_POTTERY_PATTERN_KEY), Map.entry(Items.SNORT_POTTERY_SHARD, SNORT_POTTERY_PATTERN_KEY));
   }
}
