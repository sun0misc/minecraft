...
NamedScreenHandlerFactory {
    ...
    private ServerCommandSource getCommandSource(@Nullable PlayerEntity player) {
        ...
        return new ServerCommandSource(CommandOutput.DUMMY, lv2, Vec2f.ZERO, (ServerWorld)this.world, 2, string, lv, this.world.getServer(), player);
    }
    ...
    protected void readNbt(NbtCompound nbt, RegistryWrapper.WrapperLookup registryLookup) {
        ...
        this.book = nbt.contains("Book", NbtElement.COMPOUND_TYPE) ? this.resolveBook(ItemStack.fromNbt(registryLookup, nbt.getCompound("Book")).orElse(ItemStack.EMPTY), null) : ItemStack.EMPTY;
        this.pageCount = LecternBlockEntity.getPageCount(this.book);
