...
extends DataFix {
    ...
    private <IS> TypeRewriteRule fixEquipment(Type<IS> type) {
        ...
        Type type3 = DSL.and(DSL.optional(DSL.field("ArmorItems", DSL.list(type))), DSL.optional(DSL.field("HandItems", DSL.list(type))), DSL.optional(DSL.field("body_armor_item", type)), DSL.remainderType());
