   ...
   public TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped("ItemSpawnEggFix", type, (typed) -> {
         ...
         if (optional.isPresent() && Objects.equals(((Pair)optional.get()).getSecond(), "minecraft:spawn_egg")) {
            ...
            Optional optional5 = optional4.flatMap((typedx) -> {
            ...
            if (string != null && (!optional5.isPresent() || !Objects.equals(optional5.get(), string))) {
               ...
               Typed typed6 = (Typed)((Pair)typed5.write().flatMap((dynamic2) -> {
                  return type2.readTyped(dynamic2.set("id", dynamic.createString(string)));
               }).result().orElseThrow(() -> {
