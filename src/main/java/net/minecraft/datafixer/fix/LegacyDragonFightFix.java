...
extends DataFix {
    ...
    protected TypeRewriteRule makeRule() {
        return this.fixTypeEverywhereTyped("LegacyDragonFightFix", this.getInputSchema().getType(TypeReferences.LEVEL), typed -> typed.update(DSL.remainderFinder(), levelData -> {
            ...
            Dynamic dynamic2 = levelData.get("DimensionData").get("1").get("DragonFight").orElseEmptyMap();
            return levelData.set("DragonFight", LegacyDragonFightFix.updateExitPortalLocation(dynamic2));
        }));
    }
}
