...
extends DataFix {
    ...
    private static final Set<String> ORIGINAL_ITEM_NAMES = FLATTENING_MAP.keySet().stream().map(string -> string.substring(0, string.indexOf(46))).collect(Collectors.toSet());
    ...
    public TypeRewriteRule makeRule() {
        ...
        return this.fixTypeEverywhereTyped("ItemInstanceTheFlatteningFix", type, typed -> {
            ...
            if (string != null) {
                typed2 = typed2.set(opticFinder, Pair.of(TypeReferences.ITEM_NAME.typeName(), string));
            }
    ...
    public static String getItem(@Nullable String originalName, int damage) {
        if (ORIGINAL_ITEM_NAMES.contains(originalName)) {
            String string2 = FLATTENING_MAP.get(originalName + "." + damage);
            return string2 == null ? FLATTENING_MAP.get(originalName + ".0") : string2;
        }
        return null;
    }
}
