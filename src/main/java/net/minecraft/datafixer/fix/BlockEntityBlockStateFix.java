...
public class BlockEntityBlockStateFix extends ChoiceFix {
   ...
   protected Typed transform(Typed inputType) {
      ...
      Typed typed2 = (Typed)type.pointTyped(inputType.getOps()).orElseThrow(() -> {
         return new IllegalStateException("Could not create new piston block entity.");
      });
      return typed2.set(DSL.remainderFinder(), dynamic).set(opticFinder, (Typed)((Pair)type2.readTyped(dynamic2).result().orElseThrow(() -> {
