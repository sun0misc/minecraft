...
extends DataFix {
    ...
    protected TypeRewriteRule makeRule() {
        ...
        return this.fixTypeEverywhereTyped(this.description, type, typed -> typed.update(DSL.remainderFinder(), dynamic -> dynamic.set(this.key, DataFixUtils.orElseGet(dynamic.get(this.key).result(), () -> dynamic.createBoolean(this.value)))));
    }
}
