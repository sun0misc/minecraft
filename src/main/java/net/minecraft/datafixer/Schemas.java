...
public class Schemas {
    ...
    private static void build(DataFixerBuilder builder) {
        ...
        builder.addFixer(new GameEventRenamesFix(schema65, "Recipes fix", TypeReferences.RECIPE, Schemas.replacing(FlatteningRecipeMapping.RECIPES)));
        ...
        builder.addFixer(new GameEventRenamesFix(schema67, "Recipes renamening fix", TypeReferences.RECIPE, Schemas.replacing(WoodRecipeMapping.RECIPES)));
        ...
        builder.addFixer(new GameEventRenamesFix(schema95, "Rename sugar recipe", TypeReferences.RECIPE, Schemas.replacing("minecraft:sugar", "minecraft:sugar_from_sugar_cane")));
        ...
        builder.addFixer(new GameEventRenamesFix(schema122, "Nether biome rename", TypeReferences.BIOME, Schemas.replacing("minecraft:nether", "minecraft:nether_wastes")));
        Schema schema123 = builder.addSchema(2553, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer(new GameEventRenamesFix(schema123, "Biomes fix", TypeReferences.BIOME, Schemas.replacing(FlatteningBiomeMapping.RENAMED_BIOMES)));
        ...
        builder.addFixer(BlockNameFix.create(schema128, "Renamed grass path block to dirt path", Schemas.replacing("minecraft:grass_path", "minecraft:dirt_path")));
        ...
        builder.addFixer(BlockNameFix.create(schema132, "Renamed copper blocks to new oxidized terms", Schemas.replacing(immutableMap)));
        ...
        builder.addFixer(BlockNameFix.create(schema133, "Rename copper blocks suffixes", Schemas.replacing(immutableMap2)));
        ...
        builder.addFixer(BlockNameFix.create(schema135, "Renamed grimstone blocks to deepslate", Schemas.replacing(immutableMap3)));
        Schema schema136 = builder.addSchema(2700, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer(BlockNameFix.create(schema136, "Renamed cave vines blocks", Schemas.replacing(ImmutableMap.of("minecraft:cave_vines_head", "minecraft:cave_vines", "minecraft:cave_vines_body", "minecraft:cave_vines_plant"))));
        ...
        builder.addFixer(new GameEventRenamesFix(schema147, "Caves and Cliffs biome renames", TypeReferences.BIOME, Schemas.replacing(LegacyBiomeMapping.MAP)));
        ...
        builder.addFixer(new GameEventRenamesFix(schema150, "Remove Deep Warm Ocean", TypeReferences.BIOME, Schemas.replacing("minecraft:deep_warm_ocean", "minecraft:warm_ocean")));
        ...
        builder.addFixer(RenameBlockEntityFix.create(schema181, "Rename Suspicious Sand to Brushable Block", Schemas.replacing("minecraft:suspicious_sand", "minecraft:brushable_block")));
        builder.addFixer(new EntityBrushableBlockFieldsRenameFix(schema181));
        builder.addFixer(ItemNameFix.create(schema181, "Pottery shard renaming", Schemas.replacing(ImmutableMap.of("minecraft:pottery_shard_archer", "minecraft:archer_pottery_shard", "minecraft:pottery_shard_prize", "minecraft:prize_pottery_shard", "minecraft:pottery_shard_arms_up", "minecraft:arms_up_pottery_shard", "minecraft:pottery_shard_skull", "minecraft:skull_pottery_shard"))));
        ...
        builder.addFixer(new GameEventRenamesFix(schema183, "Replace experimental 1.20 overworld", TypeReferences.MULTI_NOISE_BIOME_SOURCE_PARAMETER_LIST, Schemas.replacing("minecraft:overworld_update_1_20", "minecraft:overworld")));
        builder.addFixer(new RemoveFeatureTogglesFix(schema183, "Remove 1.20 feature toggle", Set.of("minecraft:update_1_20")));
        Schema schema184 = builder.addSchema(3441, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer(new BlendingDataFix(schema184));
        Schema schema185 = builder.addSchema(3447, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer(ItemNameFix.create(schema185, "Pottery shard item renaming to Pottery sherd", Schemas.replacing(Stream.of("minecraft:angler_pottery_shard", "minecraft:archer_pottery_shard", "minecraft:arms_up_pottery_shard", "minecraft:blade_pottery_shard", "minecraft:brewer_pottery_shard", "minecraft:burn_pottery_shard", "minecraft:danger_pottery_shard", "minecraft:explorer_pottery_shard", "minecraft:friend_pottery_shard", "minecraft:heart_pottery_shard", "minecraft:heartbreak_pottery_shard", "minecraft:howl_pottery_shard", "minecraft:miner_pottery_shard", "minecraft:mourner_pottery_shard", "minecraft:plenty_pottery_shard", "minecraft:prize_pottery_shard", "minecraft:sheaf_pottery_shard", "minecraft:shelter_pottery_shard", "minecraft:skull_pottery_shard", "minecraft:snort_pottery_shard").collect(Collectors.toMap(Function.identity(), string -> string.replace("_pottery_shard", "_pottery_sherd"))))));
        ...
        builder.addFixer(new RenameChunkStatusFix(schema187, "Remove liquid_carvers and heightmap chunk statuses", Schemas.replacing(Map.of("minecraft:liquid_carvers", "minecraft:carvers", "minecraft:heightmaps", "minecraft:spawn"))));
        ...
        builder.addFixer(new DropInvalidSignDatafixDataFix(schema190, "Drop invalid sign datafix data", "minecraft:sign"));
        builder.addFixer(new DropInvalidSignDatafixDataFix(schema190, "Drop invalid hanging sign datafix data", "minecraft:hanging_sign"));
        ...
        Schema schema209 = builder.addSchema(3813, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer(new BlockPosFormatFix(schema209));
        Schema schema210 = builder.addSchema(3814, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer(new RenameEntityAttributesFix(schema210, "Rename jump strength attribute", Schemas.replacing("minecraft:horse.jump_strength", "minecraft:generic.jump_strength")));
    ...
    private static UnaryOperator<String> replacing(String old, String current) {
        return string3 -> Objects.equals(IdentifierNormalizingSchema.normalize(string3), old) ? current : string3;
    }
}
