...
public class Schemas {
   ...
   private static synchronized DataFixer create(Set requiredTypes) {
   ...
   private static void build(DataFixerBuilder builder) {
      ...
      builder.addFixer(ItemNameFix.create(schema114, "Rename soul fire torch and soul fire lantern", replacing(ImmutableMap.of("minecraft:soul_fire_torch", "minecraft:soul_torch", "minecraft:soul_fire_lantern", "minecraft:soul_lantern"))));
      builder.addFixer(BlockNameFix.create(schema114, "Rename soul fire torch and soul fire lantern", replacing(ImmutableMap.of("minecraft:soul_fire_torch", "minecraft:soul_torch", "minecraft:soul_fire_wall_torch", "minecraft:soul_wall_torch", "minecraft:soul_fire_lantern", "minecraft:soul_lantern"))));
      ...
      builder.addFixer(JigsawBlockNameFix.create(schema135, "Renamed cave vines blocks", replacing(ImmutableMap.of("minecraft:cave_vines_head", "minecraft:cave_vines", "minecraft:cave_vines_body", "minecraft:cave_vines_plant"))));
      ...
      builder.addFixer(ItemNameFix.create(schema141, "Rename azalea_leaves_flowers", replacing(ImmutableMap.of("minecraft:azalea_leaves_flowers", "minecraft:flowering_azalea_leaves"))));
      builder.addFixer(BlockNameFix.create(schema141, "Rename azalea_leaves_flowers items", replacing(ImmutableMap.of("minecraft:azalea_leaves_flowers", "minecraft:flowering_azalea_leaves"))));
      ...
      builder.addFixer(new GameEventRenamesFix(schema149, "Remove Deep Warm Ocean", TypeReferences.BIOME, replacing("minecraft:deep_warm_ocean", "minecraft:warm_ocean")));
      Schema schema150 = builder.addSchema(2846, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new AdvancementRenameFix(schema150, false, "Rename some C&C part 2 advancements", replacing(ImmutableMap.of("minecraft:husbandry/play_jukebox_in_meadows", "minecraft:adventure/play_jukebox_in_meadows", "minecraft:adventure/caves_and_cliff", "minecraft:adventure/fall_from_world_height", "minecraft:adventure/ride_strider_in_overworld_lava", "minecraft:nether/ride_strider_in_overworld_lava"))));
      ...
      builder.addFixer(new EntityVariantTypeFix(schema161, "Change cat variant type", var10005, "minecraft:cat", "CatType", var10008::get));
      ...
      builder.addFixer(new AdvancementCriteriaRenameFix(schema161, "Migrate cat variant advancement", "minecraft:husbandry/complete_catalogue", (string) -> {
      ...
      Objects.requireNonNull(var10008);
      builder.addFixer(new EntityVariantTypeFix(schema162, "Change frog variant type", var10005, "minecraft:frog", "Variant", var10008::get));
      ...
      builder.addFixer(new AdvancementCriteriaRenameFix(schema166, "Migrate cat variant advancement for british shorthair", "minecraft:husbandry/complete_catalogue", (string) -> {
         return (String)map.getOrDefault(string, string);
      }));
      Set var191 = Set.of("minecraft:unemployed", "minecraft:nitwit");
      Objects.requireNonNull(var191);
      builder.addFixer(new PointOfInterestRemoveFix(schema166, "Remove unpopulated villager PoI types", var191::contains));
      ...
      builder.addFixer(new GameEventRenamesFix(schema182, "Replace experimental 1.20 overworld", TypeReferences.MULTI_NOISE_BIOME_SOURCE_PARAMETER_LIST, replacing("minecraft:overworld_update_1_20", "minecraft:overworld")));
   ...
   private static UnaryOperator replacing(String old, String current) {
      return (string) -> {
         return Objects.equals(string, old) ? current : string;
      };
   }

   static {
      FIXER = create(SharedConstants.requiredDataFixTypes);
   }
}
