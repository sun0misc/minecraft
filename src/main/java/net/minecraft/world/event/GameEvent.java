...
public class GameEvent {
   ...
   public GameEvent(String id, int range) {
      this.registryEntry = Registries.GAME_EVENT.createEntry(this);
      this.id = id;
      this.range = range;
   }
   ...
   private static GameEvent register(String id, int range) {
      return (GameEvent)Registry.register(Registries.GAME_EVENT, (String)id, new GameEvent(id, range));
   }
   ...
   public static record Emitter(@Nullable Entity sourceEntity, @Nullable BlockState affectedState) {
      public Emitter(@Nullable Entity arg, @Nullable BlockState arg2) {
         this.sourceEntity = arg;
         this.affectedState = arg2;
      }
