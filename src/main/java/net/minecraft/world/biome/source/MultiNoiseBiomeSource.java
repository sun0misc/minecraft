...
extends BiomeSource {
    ...
    public static final MapCodec<MultiNoiseBiomeSource> CODEC = Codec.mapEither(CUSTOM_CODEC, PRESET_CODEC).xmap(MultiNoiseBiomeSource::new, source -> source.biomeEntries);
    ...
    public void addDebugInfo(List<String> info, BlockPos pos, MultiNoiseUtil.MultiNoiseSampler noiseSampler) {
        ...
        info.add("Biome builder PV: " + VanillaBiomeParameters.getPeaksValleysDescription(d) + " C: " + lv2.getContinentalnessDescription(f) + " E: " + lv2.getErosionDescription(g) + " T: " + lv2.getTemperatureDescription(h) + " H: " + lv2.getHumidityDescription(l));
    }
}
