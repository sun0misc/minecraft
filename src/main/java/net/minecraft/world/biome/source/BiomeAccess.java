...
public class BiomeAccess {
   ...
   public RegistryEntry getBiomeForNoiseGen(double x, double y, double z) {
   ...
   public RegistryEntry getBiomeForNoiseGen(BlockPos pos) {
   ...
   public interface Storage {
      RegistryEntry getBiomeForNoiseGen(int biomeX, int biomeY, int biomeZ);
   }
}
