...
public abstract class BiomeKeys {
    ...
    public static final RegistryKey<Biome> CHERRY_GROVE = BiomeKeys.register("cherry_grove");
    ...
    public static final RegistryKey<Biome> DEEP_DARK = BiomeKeys.register("deep_dark");
