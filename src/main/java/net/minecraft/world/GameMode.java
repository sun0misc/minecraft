...
public enum GameMode implements StringIdentifiable {
   ...
   public static final StringIdentifiable.Codec CODEC = StringIdentifiable.createCodec(GameMode::values);
   private static final IntFunction BY_ID = ValueLists.createIdToValueFunction(GameMode::getId, values(), (ValueLists.OutOfBoundsHandling)ValueLists.OutOfBoundsHandling.ZERO);
   ...
   public static GameMode byName(String name, @Nullable GameMode defaultMode) {
      GameMode lv = (GameMode)CODEC.byId(name);
      return lv != null ? lv : defaultMode;
   }
