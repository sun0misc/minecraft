...
extends FoliagePlacer {
    public static final MapCodec<JungleFoliagePlacer> CODEC = RecordCodecBuilder.mapCodec(instance -> JungleFoliagePlacer.fillFoliagePlacerFields(instance).and(((MapCodec)Codec.intRange(0, 16).fieldOf("height")).forGetter(placer -> placer.height)).apply((Applicative<JungleFoliagePlacer, ?>)instance, JungleFoliagePlacer::new));
