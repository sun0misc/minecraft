...
public interface BlockPredicateType<P extends BlockPredicate> {
    ...
    public static final BlockPredicateType<UnobstructedBlockPredicate> UNOBSTRUCTED = BlockPredicateType.register("unobstructed", UnobstructedBlockPredicate.CODEC);
