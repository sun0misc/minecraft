...
public class RandomOffsetPlacementModifier extends PlacementModifier {
   public static final Codec MODIFIER_CODEC = RecordCodecBuilder.create((instance) -> {
      return instance.group(IntProvider.createValidatingCodec(-16, 16).fieldOf("xz_spread").forGetter((arg) -> {
         return arg.spreadXz;
      }), IntProvider.createValidatingCodec(-16, 16).fieldOf("y_spread").forGetter((arg) -> {
         return arg.spreadY;
