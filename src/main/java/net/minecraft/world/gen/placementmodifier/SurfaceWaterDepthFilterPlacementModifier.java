...
extends AbstractConditionalPlacementModifier {
    public static final MapCodec<SurfaceWaterDepthFilterPlacementModifier> MODIFIER_CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(((MapCodec)Codec.INT.fieldOf("max_water_depth")).forGetter(arg -> arg.maxWaterDepth)).apply((Applicative<SurfaceWaterDepthFilterPlacementModifier, ?>)instance, SurfaceWaterDepthFilterPlacementModifier::new));
