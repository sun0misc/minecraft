...
public interface StructureKeys {
    ...
    public static final RegistryKey<Structure> TRAIL_RUINS = StructureKeys.of("trail_ruins");
    public static final RegistryKey<Structure> TRIAL_CHAMBERS = StructureKeys.of("trial_chambers");
