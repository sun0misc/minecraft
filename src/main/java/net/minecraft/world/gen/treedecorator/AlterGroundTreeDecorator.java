...
extends TreeDecorator {
    public static final MapCodec<AlterGroundTreeDecorator> CODEC = ((MapCodec)BlockStateProvider.TYPE_CODEC.fieldOf("provider")).xmap(AlterGroundTreeDecorator::new, decorator -> decorator.provider);
    ...
    private void setColumn(TreeDecorator.Generator generator, BlockPos origin) {
        for (int i = 2; i >= -3; --i) {
            ...
            if (!generator.isAir(lv) && i < 0) break;
        }
    }
}
