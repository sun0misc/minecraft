...
public class TreeConfiguredFeatures {
    ...
    public static void bootstrap(Registerable<ConfiguredFeature<?, ?>> featureRegisterable) {
        RegistryEntryLookup<Block> lv = featureRegisterable.getRegistryLookup(RegistryKeys.BLOCK);
        BlockPredicate lv2 = BlockPredicate.matchingBlocks(Blocks.OAK_SAPLING, Blocks.SPRUCE_SAPLING, Blocks.BIRCH_SAPLING, Blocks.JUNGLE_SAPLING, Blocks.ACACIA_SAPLING, Blocks.CHERRY_SAPLING, Blocks.DARK_OAK_SAPLING, Blocks.MANGROVE_PROPAGULE, Blocks.DANDELION, Blocks.TORCHFLOWER, Blocks.POPPY, Blocks.BLUE_ORCHID, Blocks.ALLIUM, Blocks.AZURE_BLUET, Blocks.RED_TULIP, Blocks.ORANGE_TULIP, Blocks.WHITE_TULIP, Blocks.PINK_TULIP, Blocks.OXEYE_DAISY, Blocks.CORNFLOWER, Blocks.WITHER_ROSE, Blocks.LILY_OF_THE_VALLEY, Blocks.BROWN_MUSHROOM, Blocks.RED_MUSHROOM, Blocks.WHEAT, Blocks.SUGAR_CANE, Blocks.ATTACHED_PUMPKIN_STEM, Blocks.ATTACHED_MELON_STEM, Blocks.PUMPKIN_STEM, Blocks.MELON_STEM, Blocks.LILY_PAD, Blocks.NETHER_WART, Blocks.COCOA, Blocks.CARROTS, Blocks.POTATOES, Blocks.CHORUS_PLANT, Blocks.CHORUS_FLOWER, Blocks.TORCHFLOWER_CROP, Blocks.PITCHER_CROP, Blocks.BEETROOTS, Blocks.SWEET_BERRY_BUSH, Blocks.WARPED_FUNGUS, Blocks.CRIMSON_FUNGUS, Blocks.WEEPING_VINES, Blocks.WEEPING_VINES_PLANT, Blocks.TWISTING_VINES, Blocks.TWISTING_VINES_PLANT, Blocks.CAVE_VINES, Blocks.CAVE_VINES_PLANT, Blocks.SPORE_BLOSSOM, Blocks.AZALEA, Blocks.FLOWERING_AZALEA, Blocks.MOSS_CARPET, Blocks.PINK_PETALS, Blocks.BIG_DRIPLEAF, Blocks.BIG_DRIPLEAF_STEM, Blocks.SMALL_DRIPLEAF);
        ConfiguredFeatures.register(featureRegisterable, CRIMSON_FUNGUS, Feature.HUGE_FUNGUS, new HugeFungusFeatureConfig(Blocks.CRIMSON_NYLIUM.getDefaultState(), Blocks.CRIMSON_STEM.getDefaultState(), Blocks.NETHER_WART_BLOCK.getDefaultState(), Blocks.SHROOMLIGHT.getDefaultState(), lv2, false));
        ConfiguredFeatures.register(featureRegisterable, CRIMSON_FUNGUS_PLANTED, Feature.HUGE_FUNGUS, new HugeFungusFeatureConfig(Blocks.CRIMSON_NYLIUM.getDefaultState(), Blocks.CRIMSON_STEM.getDefaultState(), Blocks.NETHER_WART_BLOCK.getDefaultState(), Blocks.SHROOMLIGHT.getDefaultState(), lv2, true));
        ConfiguredFeatures.register(featureRegisterable, WARPED_FUNGUS, Feature.HUGE_FUNGUS, new HugeFungusFeatureConfig(Blocks.WARPED_NYLIUM.getDefaultState(), Blocks.WARPED_STEM.getDefaultState(), Blocks.WARPED_WART_BLOCK.getDefaultState(), Blocks.SHROOMLIGHT.getDefaultState(), lv2, false));
        ConfiguredFeatures.register(featureRegisterable, WARPED_FUNGUS_PLANTED, Feature.HUGE_FUNGUS, new HugeFungusFeatureConfig(Blocks.WARPED_NYLIUM.getDefaultState(), Blocks.WARPED_STEM.getDefaultState(), Blocks.WARPED_WART_BLOCK.getDefaultState(), Blocks.SHROOMLIGHT.getDefaultState(), lv2, true));
        ...
        BeehiveTreeDecorator lv3 = new BeehiveTreeDecorator(0.002f);
        BeehiveTreeDecorator lv4 = new BeehiveTreeDecorator(0.01f);
        BeehiveTreeDecorator lv5 = new BeehiveTreeDecorator(0.02f);
        BeehiveTreeDecorator lv6 = new BeehiveTreeDecorator(0.05f);
        BeehiveTreeDecorator lv7 = new BeehiveTreeDecorator(1.0f);
        ...
        ConfiguredFeatures.register(featureRegisterable, CHERRY_BEES_005, Feature.TREE, TreeConfiguredFeatures.cherry().decorators(List.of(lv6)).build());
        ...
        ConfiguredFeatures.register(featureRegisterable, SUPER_BIRCH_BEES_0002, Feature.TREE, TreeConfiguredFeatures.superBirch().decorators(ImmutableList.of(lv3)).build());
        ConfiguredFeatures.register(featureRegisterable, SUPER_BIRCH_BEES, Feature.TREE, TreeConfiguredFeatures.superBirch().decorators(ImmutableList.of(lv7)).build());
        ...
        ConfiguredFeatures.register(featureRegisterable, MANGROVE, Feature.TREE, new TreeFeatureConfig.Builder(BlockStateProvider.of(Blocks.MANGROVE_LOG), new UpwardsBranchingTrunkPlacer(2, 1, 4, UniformIntProvider.create(1, 4), 0.5f, UniformIntProvider.create(0, 1), lv.getOrThrow(BlockTags.MANGROVE_LOGS_CAN_GROW_THROUGH)), BlockStateProvider.of(Blocks.MANGROVE_LEAVES), new RandomSpreadFoliagePlacer(ConstantIntProvider.create(3), ConstantIntProvider.create(0), ConstantIntProvider.create(2), 70), Optional.of(new MangroveRootPlacer(UniformIntProvider.create(1, 3), BlockStateProvider.of(Blocks.MANGROVE_ROOTS), Optional.of(new AboveRootPlacement(BlockStateProvider.of(Blocks.MOSS_CARPET), 0.5f)), new MangroveRootPlacement(lv.getOrThrow(BlockTags.MANGROVE_ROOTS_CAN_GROW_THROUGH), RegistryEntryList.of(Block::getRegistryEntry, Blocks.MUD, Blocks.MUDDY_MANGROVE_ROOTS), BlockStateProvider.of(Blocks.MUDDY_MANGROVE_ROOTS), 8, 15, 0.2f))), new TwoLayersFeatureSize(2, 0, 2)).decorators(List.of(new LeavesVineTreeDecorator(0.125f), new AttachedToLeavesTreeDecorator(0.14f, 1, 0, new RandomizedIntBlockStateProvider((BlockStateProvider)BlockStateProvider.of((BlockState)Blocks.MANGROVE_PROPAGULE.getDefaultState().with(PropaguleBlock.HANGING, true)), PropaguleBlock.AGE, (IntProvider)UniformIntProvider.create(0, 4)), 2, List.of(Direction.DOWN)), lv4)).ignoreVines().build());
        ConfiguredFeatures.register(featureRegisterable, TALL_MANGROVE, Feature.TREE, new TreeFeatureConfig.Builder(BlockStateProvider.of(Blocks.MANGROVE_LOG), new UpwardsBranchingTrunkPlacer(4, 1, 9, UniformIntProvider.create(1, 6), 0.5f, UniformIntProvider.create(0, 1), lv.getOrThrow(BlockTags.MANGROVE_LOGS_CAN_GROW_THROUGH)), BlockStateProvider.of(Blocks.MANGROVE_LEAVES), new RandomSpreadFoliagePlacer(ConstantIntProvider.create(3), ConstantIntProvider.create(0), ConstantIntProvider.create(2), 70), Optional.of(new MangroveRootPlacer(UniformIntProvider.create(3, 7), BlockStateProvider.of(Blocks.MANGROVE_ROOTS), Optional.of(new AboveRootPlacement(BlockStateProvider.of(Blocks.MOSS_CARPET), 0.5f)), new MangroveRootPlacement(lv.getOrThrow(BlockTags.MANGROVE_ROOTS_CAN_GROW_THROUGH), RegistryEntryList.of(Block::getRegistryEntry, Blocks.MUD, Blocks.MUDDY_MANGROVE_ROOTS), BlockStateProvider.of(Blocks.MUDDY_MANGROVE_ROOTS), 8, 15, 0.2f))), new TwoLayersFeatureSize(3, 0, 2)).decorators(List.of(new LeavesVineTreeDecorator(0.125f), new AttachedToLeavesTreeDecorator(0.14f, 1, 0, new RandomizedIntBlockStateProvider((BlockStateProvider)BlockStateProvider.of((BlockState)Blocks.MANGROVE_PROPAGULE.getDefaultState().with(PropaguleBlock.HANGING, true)), PropaguleBlock.AGE, (IntProvider)UniformIntProvider.create(0, 4)), 2, List.of(Direction.DOWN)), lv4)).ignoreVines().build());
        ConfiguredFeatures.register(featureRegisterable, OAK_BEES_0002, Feature.TREE, TreeConfiguredFeatures.oak().decorators(List.of(lv3)).build());
        ConfiguredFeatures.register(featureRegisterable, OAK_BEES_002, Feature.TREE, TreeConfiguredFeatures.oak().decorators(List.of(lv5)).build());
        ConfiguredFeatures.register(featureRegisterable, OAK_BEES_005, Feature.TREE, TreeConfiguredFeatures.oak().decorators(List.of(lv6)).build());
        ConfiguredFeatures.register(featureRegisterable, BIRCH_BEES_0002, Feature.TREE, TreeConfiguredFeatures.birch().decorators(List.of(lv3)).build());
        ConfiguredFeatures.register(featureRegisterable, BIRCH_BEES_002, Feature.TREE, TreeConfiguredFeatures.birch().decorators(List.of(lv5)).build());
        ConfiguredFeatures.register(featureRegisterable, BIRCH_BEES_005, Feature.TREE, TreeConfiguredFeatures.birch().decorators(List.of(lv6)).build());
        ConfiguredFeatures.register(featureRegisterable, FANCY_OAK_BEES_0002, Feature.TREE, TreeConfiguredFeatures.fancyOak().decorators(List.of(lv3)).build());
        ConfiguredFeatures.register(featureRegisterable, FANCY_OAK_BEES_002, Feature.TREE, TreeConfiguredFeatures.fancyOak().decorators(List.of(lv5)).build());
        ConfiguredFeatures.register(featureRegisterable, FANCY_OAK_BEES_005, Feature.TREE, TreeConfiguredFeatures.fancyOak().decorators(List.of(lv6)).build());
        ConfiguredFeatures.register(featureRegisterable, FANCY_OAK_BEES, Feature.TREE, TreeConfiguredFeatures.fancyOak().decorators(List.of(lv7)).build());
    }
}
