...
public class OreConfiguredFeatures {
    ...
    public static void bootstrap(Registerable<ConfiguredFeature<?, ?>> featureRegisterable) {
        TagMatchRuleTest lv = new TagMatchRuleTest(BlockTags.BASE_STONE_OVERWORLD);
        TagMatchRuleTest lv2 = new TagMatchRuleTest(BlockTags.STONE_ORE_REPLACEABLES);
        TagMatchRuleTest lv3 = new TagMatchRuleTest(BlockTags.DEEPSLATE_ORE_REPLACEABLES);
        BlockMatchRuleTest lv4 = new BlockMatchRuleTest(Blocks.NETHERRACK);
        TagMatchRuleTest lv5 = new TagMatchRuleTest(BlockTags.BASE_STONE_NETHER);
        List<OreFeatureConfig.Target> list = List.of(OreFeatureConfig.createTarget(lv2, Blocks.IRON_ORE.getDefaultState()), OreFeatureConfig.createTarget(lv3, Blocks.DEEPSLATE_IRON_ORE.getDefaultState()));
        List<OreFeatureConfig.Target> list2 = List.of(OreFeatureConfig.createTarget(lv2, Blocks.GOLD_ORE.getDefaultState()), OreFeatureConfig.createTarget(lv3, Blocks.DEEPSLATE_GOLD_ORE.getDefaultState()));
        List<OreFeatureConfig.Target> list3 = List.of(OreFeatureConfig.createTarget(lv2, Blocks.DIAMOND_ORE.getDefaultState()), OreFeatureConfig.createTarget(lv3, Blocks.DEEPSLATE_DIAMOND_ORE.getDefaultState()));
        List<OreFeatureConfig.Target> list4 = List.of(OreFeatureConfig.createTarget(lv2, Blocks.LAPIS_ORE.getDefaultState()), OreFeatureConfig.createTarget(lv3, Blocks.DEEPSLATE_LAPIS_ORE.getDefaultState()));
        List<OreFeatureConfig.Target> list5 = List.of(OreFeatureConfig.createTarget(lv2, Blocks.COPPER_ORE.getDefaultState()), OreFeatureConfig.createTarget(lv3, Blocks.DEEPSLATE_COPPER_ORE.getDefaultState()));
        List<OreFeatureConfig.Target> list6 = List.of(OreFeatureConfig.createTarget(lv2, Blocks.COAL_ORE.getDefaultState()), OreFeatureConfig.createTarget(lv3, Blocks.DEEPSLATE_COAL_ORE.getDefaultState()));
        ConfiguredFeatures.register(featureRegisterable, ORE_MAGMA, Feature.ORE, new OreFeatureConfig(lv4, Blocks.MAGMA_BLOCK.getDefaultState(), 33));
        ConfiguredFeatures.register(featureRegisterable, ORE_SOUL_SAND, Feature.ORE, new OreFeatureConfig(lv4, Blocks.SOUL_SAND.getDefaultState(), 12));
        ConfiguredFeatures.register(featureRegisterable, ORE_NETHER_GOLD, Feature.ORE, new OreFeatureConfig(lv4, Blocks.NETHER_GOLD_ORE.getDefaultState(), 10));
        ConfiguredFeatures.register(featureRegisterable, ORE_QUARTZ, Feature.ORE, new OreFeatureConfig(lv4, Blocks.NETHER_QUARTZ_ORE.getDefaultState(), 14));
        ConfiguredFeatures.register(featureRegisterable, ORE_GRAVEL_NETHER, Feature.ORE, new OreFeatureConfig(lv4, Blocks.GRAVEL.getDefaultState(), 33));
        ConfiguredFeatures.register(featureRegisterable, ORE_BLACKSTONE, Feature.ORE, new OreFeatureConfig(lv4, Blocks.BLACKSTONE.getDefaultState(), 33));
        ConfiguredFeatures.register(featureRegisterable, ORE_DIRT, Feature.ORE, new OreFeatureConfig(lv, Blocks.DIRT.getDefaultState(), 33));
        ConfiguredFeatures.register(featureRegisterable, ORE_GRAVEL, Feature.ORE, new OreFeatureConfig(lv, Blocks.GRAVEL.getDefaultState(), 33));
        ConfiguredFeatures.register(featureRegisterable, ORE_GRANITE, Feature.ORE, new OreFeatureConfig(lv, Blocks.GRANITE.getDefaultState(), 64));
        ConfiguredFeatures.register(featureRegisterable, ORE_DIORITE, Feature.ORE, new OreFeatureConfig(lv, Blocks.DIORITE.getDefaultState(), 64));
        ConfiguredFeatures.register(featureRegisterable, ORE_ANDESITE, Feature.ORE, new OreFeatureConfig(lv, Blocks.ANDESITE.getDefaultState(), 64));
        ConfiguredFeatures.register(featureRegisterable, ORE_TUFF, Feature.ORE, new OreFeatureConfig(lv, Blocks.TUFF.getDefaultState(), 64));
        ...
        ConfiguredFeatures.register(featureRegisterable, ORE_REDSTONE, Feature.ORE, new OreFeatureConfig(List.of(OreFeatureConfig.createTarget(lv2, Blocks.REDSTONE_ORE.getDefaultState()), OreFeatureConfig.createTarget(lv3, Blocks.DEEPSLATE_REDSTONE_ORE.getDefaultState())), 8));
        ...
        ConfiguredFeatures.register(featureRegisterable, ORE_INFESTED, Feature.ORE, new OreFeatureConfig(List.of(OreFeatureConfig.createTarget(lv2, Blocks.INFESTED_STONE.getDefaultState()), OreFeatureConfig.createTarget(lv3, Blocks.INFESTED_DEEPSLATE.getDefaultState())), 9));
        ConfiguredFeatures.register(featureRegisterable, ORE_EMERALD, Feature.ORE, new OreFeatureConfig(List.of(OreFeatureConfig.createTarget(lv2, Blocks.EMERALD_ORE.getDefaultState()), OreFeatureConfig.createTarget(lv3, Blocks.DEEPSLATE_EMERALD_ORE.getDefaultState())), 3));
        ConfiguredFeatures.register(featureRegisterable, ORE_ANCIENT_DEBRIS_LARGE, Feature.SCATTERED_ORE, new OreFeatureConfig(lv5, Blocks.ANCIENT_DEBRIS.getDefaultState(), 3, 1.0f));
        ConfiguredFeatures.register(featureRegisterable, ORE_ANCIENT_DEBRIS_SMALL, Feature.SCATTERED_ORE, new OreFeatureConfig(lv5, Blocks.ANCIENT_DEBRIS.getDefaultState(), 2, 1.0f));
        ...
        ConfiguredFeatures.register(featureRegisterable, ORE_CLAY, Feature.ORE, new OreFeatureConfig(lv, Blocks.CLAY.getDefaultState(), 33));
    }
}
