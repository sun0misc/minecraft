...
public class UndergroundConfiguredFeatures {
   ...
   public static void bootstrap(Registerable featureRegisterable) {
      ...
      RegistryEntryLookup lv2 = featureRegisterable.getRegistryLookup(RegistryKeys.PROCESSOR_LIST);
      ConfiguredFeatures.register(featureRegisterable, MONSTER_ROOM, Feature.MONSTER_ROOM);
      List list = List.of(new Identifier("fossil/spine_1"), new Identifier("fossil/spine_2"), new Identifier("fossil/spine_3"), new Identifier("fossil/spine_4"), new Identifier("fossil/skull_1"), new Identifier("fossil/skull_2"), new Identifier("fossil/skull_3"), new Identifier("fossil/skull_4"));
      List list2 = List.of(new Identifier("fossil/spine_1_coal"), new Identifier("fossil/spine_2_coal"), new Identifier("fossil/spine_3_coal"), new Identifier("fossil/spine_4_coal"), new Identifier("fossil/skull_1_coal"), new Identifier("fossil/skull_2_coal"), new Identifier("fossil/skull_3_coal"), new Identifier("fossil/skull_4_coal"));
      RegistryEntry lv3 = lv2.getOrThrow(StructureProcessorLists.FOSSIL_ROT);
      ...
      RandomizedIntBlockStateProvider lv6 = new RandomizedIntBlockStateProvider(new WeightedBlockStateProvider(DataPool.builder().add(Blocks.CAVE_VINES.getDefaultState(), 4).add((BlockState)Blocks.CAVE_VINES.getDefaultState().with(CaveVines.BERRIES, true), 1)), CaveVinesHeadBlock.AGE, UniformIntProvider.create(23, 25));
      ...
      ConfiguredFeatures.register(featureRegisterable, MOSS_PATCH, Feature.VEGETATION_PATCH, new VegetationPatchFeatureConfig(BlockTags.MOSS_REPLACEABLE, BlockStateProvider.of(Blocks.MOSS_BLOCK), PlacedFeatures.createEntry((RegistryEntry)lv.getOrThrow(MOSS_VEGETATION), (PlacementModifier[])()), VerticalSurfaceType.FLOOR, ConstantIntProvider.create(1), 0.0F, 5, 0.8F, UniformIntProvider.create(4, 7), 0.3F));
      ConfiguredFeatures.register(featureRegisterable, MOSS_PATCH_BONEMEAL, Feature.VEGETATION_PATCH, new VegetationPatchFeatureConfig(BlockTags.MOSS_REPLACEABLE, BlockStateProvider.of(Blocks.MOSS_BLOCK), PlacedFeatures.createEntry((RegistryEntry)lv.getOrThrow(MOSS_VEGETATION), (PlacementModifier[])()), VerticalSurfaceType.FLOOR, ConstantIntProvider.create(1), 0.0F, 5, 0.6F, UniformIntProvider.create(1, 2), 0.75F));
      ...
      ConfiguredFeatures.register(featureRegisterable, CLAY_WITH_DRIPLEAVES, Feature.VEGETATION_PATCH, new VegetationPatchFeatureConfig(BlockTags.LUSH_GROUND_REPLACEABLE, BlockStateProvider.of(Blocks.CLAY), PlacedFeatures.createEntry((RegistryEntry)lv.getOrThrow(DRIPLEAF), (PlacementModifier[])()), VerticalSurfaceType.FLOOR, ConstantIntProvider.create(3), 0.8F, 2, 0.05F, UniformIntProvider.create(4, 7), 0.7F));
      ConfiguredFeatures.register(featureRegisterable, CLAY_POOL_WITH_DRIPLEAVES, Feature.WATERLOGGED_VEGETATION_PATCH, new VegetationPatchFeatureConfig(BlockTags.LUSH_GROUND_REPLACEABLE, BlockStateProvider.of(Blocks.CLAY), PlacedFeatures.createEntry((RegistryEntry)lv.getOrThrow(DRIPLEAF), (PlacementModifier[])()), VerticalSurfaceType.FLOOR, ConstantIntProvider.create(3), 0.8F, 5, 0.1F, UniformIntProvider.create(4, 7), 0.7F));
      ConfiguredFeatures.register(featureRegisterable, LUSH_CAVES_CLAY, Feature.RANDOM_BOOLEAN_SELECTOR, new RandomBooleanFeatureConfig(PlacedFeatures.createEntry((RegistryEntry)lv.getOrThrow(CLAY_WITH_DRIPLEAVES), (PlacementModifier[])()), PlacedFeatures.createEntry((RegistryEntry)lv.getOrThrow(CLAY_POOL_WITH_DRIPLEAVES), (PlacementModifier[])())));
      ConfiguredFeatures.register(featureRegisterable, MOSS_PATCH_CEILING, Feature.VEGETATION_PATCH, new VegetationPatchFeatureConfig(BlockTags.MOSS_REPLACEABLE, BlockStateProvider.of(Blocks.MOSS_BLOCK), PlacedFeatures.createEntry((RegistryEntry)lv.getOrThrow(CAVE_VINE_IN_MOSS), (PlacementModifier[])()), VerticalSurfaceType.CEILING, UniformIntProvider.create(1, 2), 0.0F, 5, 0.08F, UniformIntProvider.create(4, 7), 0.3F));
      ...
      ConfiguredFeatures.register(featureRegisterable, SCULK_VEIN, Feature.MULTIFACE_GROWTH, new MultifaceGrowthFeatureConfig(lv7, 20, true, true, true, 1.0F, RegistryEntryList.of((Function)(Block::getRegistryEntry), (Object[])(Blocks.STONE, Blocks.ANDESITE, Blocks.DIORITE, Blocks.GRANITE, Blocks.DRIPSTONE_BLOCK, Blocks.CALCITE, Blocks.TUFF, Blocks.DEEPSLATE))));
   }
}
