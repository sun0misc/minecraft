...
public class PileConfiguredFeatures {
    ...
    public static void bootstrap(Registerable<ConfiguredFeature<?, ?>> featureRegisterable) {
        ...
        ConfiguredFeatures.register(featureRegisterable, PILE_ICE, Feature.BLOCK_PILE, new BlockPileFeatureConfig(new WeightedBlockStateProvider(DataPool.builder().add(Blocks.BLUE_ICE.getDefaultState(), 1).add(Blocks.PACKED_ICE.getDefaultState(), 5))));
        ConfiguredFeatures.register(featureRegisterable, PILE_PUMPKIN, Feature.BLOCK_PILE, new BlockPileFeatureConfig(new WeightedBlockStateProvider(DataPool.builder().add(Blocks.PUMPKIN.getDefaultState(), 19).add(Blocks.JACK_O_LANTERN.getDefaultState(), 1))));
    }
}
