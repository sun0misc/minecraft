...
implements FeatureConfig {
    public static final Codec<RootSystemFeatureConfig> CODEC = RecordCodecBuilder.create(instance -> instance.group(((MapCodec)PlacedFeature.REGISTRY_CODEC.fieldOf("feature")).forGetter(config -> config.feature), ((MapCodec)Codec.intRange(1, 64).fieldOf("required_vertical_space_for_tree")).forGetter(config -> config.requiredVerticalSpaceForTree), ((MapCodec)Codec.intRange(1, 64).fieldOf("root_radius")).forGetter(config -> config.rootRadius), ((MapCodec)TagKey.codec(RegistryKeys.BLOCK).fieldOf("root_replaceable")).forGetter(config -> config.rootReplaceable), ((MapCodec)BlockStateProvider.TYPE_CODEC.fieldOf("root_state_provider")).forGetter(config -> config.rootStateProvider), ((MapCodec)Codec.intRange(1, 256).fieldOf("root_placement_attempts")).forGetter(config -> config.rootPlacementAttempts), ((MapCodec)Codec.intRange(1, 4096).fieldOf("root_column_max_height")).forGetter(config -> config.maxRootColumnHeight), ((MapCodec)Codec.intRange(1, 64).fieldOf("hanging_root_radius")).forGetter(config -> config.hangingRootRadius), ((MapCodec)Codec.intRange(0, 16).fieldOf("hanging_roots_vertical_span")).forGetter(config -> config.hangingRootVerticalSpan), ((MapCodec)BlockStateProvider.TYPE_CODEC.fieldOf("hanging_root_state_provider")).forGetter(config -> config.hangingRootStateProvider), ((MapCodec)Codec.intRange(1, 256).fieldOf("hanging_root_placement_attempts")).forGetter(config -> config.hangingRootPlacementAttempts), ((MapCodec)Codec.intRange(1, 64).fieldOf("allowed_vertical_water_for_tree")).forGetter(config -> config.allowedVerticalWaterForTree), ((MapCodec)BlockPredicate.BASE_CODEC.fieldOf("allowed_tree_position")).forGetter(config -> config.predicate)).apply((Applicative<RootSystemFeatureConfig, ?>)instance, RootSystemFeatureConfig::new));
