...
public class EndPortalBlockEntityRenderer implements BlockEntityRenderer {
   ...
   public void render(EndPortalBlockEntity arg, float f, MatrixStack arg2, VertexConsumerProvider arg3, int i, int j) {
      Matrix4f matrix4f = arg2.peek().getPositionMatrix();
      this.renderSides(arg, matrix4f, arg3.getBuffer(this.getLayer()));
   }
