...
extends AnimalModel<T> {
    ...
    public static ModelData getModelData(int stanceWidth, Dilation dilation) {
        ...
        lv2.addChild(EntityModelPartNames.HEAD, ModelPartBuilder.create().uv(0, 0).cuboid(-4.0f, -4.0f, -8.0f, 8.0f, 8.0f, 8.0f, dilation), ModelTransform.pivot(0.0f, 18 - stanceWidth, -6.0f));
        ...
        lv2.addChild(EntityModelPartNames.RIGHT_HIND_LEG, lv3, ModelTransform.pivot(-3.0f, 24 - stanceWidth, 7.0f));
        lv2.addChild(EntityModelPartNames.LEFT_HIND_LEG, lv3, ModelTransform.pivot(3.0f, 24 - stanceWidth, 7.0f));
        lv2.addChild(EntityModelPartNames.RIGHT_FRONT_LEG, lv3, ModelTransform.pivot(-3.0f, 24 - stanceWidth, -5.0f));
        lv2.addChild(EntityModelPartNames.LEFT_FRONT_LEG, lv3, ModelTransform.pivot(3.0f, 24 - stanceWidth, -5.0f));
        return lv;
    }
