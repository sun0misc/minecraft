...
public class IronGolemEntityModel extends SinglePartEntityModel {
   ...
   public void setAngles(IronGolemEntity arg, float f, float g, float h, float i, float j) {
   ...
   public void animateModel(IronGolemEntity arg, float f, float g, float h) {
      int i = arg.getAttackTicksLeft();
      if (i > 0) {
         ...
         int j = arg.getLookingAtVillagerTicks();
         if (j > 0) {
