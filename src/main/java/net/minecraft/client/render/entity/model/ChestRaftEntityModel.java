...
extends RaftEntityModel {
    ...
    public ChestRaftEntityModel(ModelPart arg) {
        super(arg);
    }
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        lv2.addChild(CHEST_BOTTOM, ModelPartBuilder.create().uv(0, 76).cuboid(0.0f, 0.0f, 0.0f, 12.0f, 8.0f, 12.0f), ModelTransform.of(-2.0f, -10.1f, -6.0f, 0.0f, -1.5707964f, 0.0f));
        lv2.addChild(CHEST_LID, ModelPartBuilder.create().uv(0, 59).cuboid(0.0f, 0.0f, 0.0f, 12.0f, 4.0f, 12.0f), ModelTransform.of(-2.0f, -14.1f, -6.0f, 0.0f, -1.5707964f, 0.0f));
        lv2.addChild(CHEST_LOCK, ModelPartBuilder.create().uv(0, 59).cuboid(0.0f, 0.0f, 0.0f, 2.0f, 4.0f, 1.0f), ModelTransform.of(-1.0f, -11.1f, -1.0f, 0.0f, -1.5707964f, 0.0f));
