...
public class Frustum {
   ...
   public Frustum method_38557(int i) {
      ...
      for(double j = Math.ceil(this.z / (double)i) * (double)i; this.frustumIntersection.intersectAab((float)(d - this.x), (float)(e - this.y), (float)(f - this.z), (float)(g - this.x), (float)(h - this.y), (float)(j - this.z)) != -2; this.z -= (double)(this.field_34821.z() * 4.0F)) {
