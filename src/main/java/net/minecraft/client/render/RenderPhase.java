...
public abstract class RenderPhase {
    ...
    protected static final ShaderProgram CLOUDS_PROGRAM = new ShaderProgram(GameRenderer::getRenderTypeCloudsProgram);
    protected static final ShaderProgram LINES_PROGRAM = new ShaderProgram(GameRenderer::getRenderTypeLinesProgram);
    protected static final ShaderProgram GUI_PROGRAM = new ShaderProgram(GameRenderer::getRenderTypeGuiProgram);
    protected static final ShaderProgram GUI_OVERLAY_PROGRAM = new ShaderProgram(GameRenderer::getRenderTypeGuiOverlayProgram);
    protected static final ShaderProgram GUI_TEXT_HIGHLIGHT_PROGRAM = new ShaderProgram(GameRenderer::getRenderTypeGuiTextHighlightProgram);
    protected static final ShaderProgram GUI_GHOST_RECIPE_OVERLAY_PROGRAM = new ShaderProgram(GameRenderer::getRenderTypeGuiGhostRecipeOverlayProgram);
    protected static final ShaderProgram BREEZE_WIND_PROGRAM = new ShaderProgram(GameRenderer::getRenderTypeBreezeWindProgram);
    ...
    extends TextureBase {
        ...
        @Override
        public String toString() {
            return this.name + "[" + String.valueOf(this.id) + "(blur=" + this.blur + ", mipmap=" + this.mipmap + ")]";
        }
