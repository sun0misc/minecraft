...
extends Screen {
    ...
    protected EditBoxWidget createCommentsBox(int width, int height, Consumer<String> changeListener) {
        ...
        EditBoxWidget lv = new EditBoxWidget(this.textRenderer, 0, 0, width, height, DESCRIBE_TEXT, COMMENTS_TEXT);
    ...
    extends WarningScreen {
        ...
        protected LayoutWidget getLayout() {
            ...
            lv2.add(ButtonWidget.builder(RETURN_BUTTON_TEXT, arg -> this.close()).build());
            lv2.add(ButtonWidget.builder(DRAFT_BUTTON_TEXT, arg -> {
                ReportScreen.this.saveDraft();
                this.client.setScreen(ReportScreen.this.parent);
            }).build());
            lv.add(ButtonWidget.builder(DISCARD_BUTTON_TEXT, arg -> {
