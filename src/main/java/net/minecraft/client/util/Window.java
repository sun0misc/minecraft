...
public final class Window implements AutoCloseable {
   ...
   public void setIcon(InputSupplier smallIconSupplier, InputSupplier bigIconSupplier) {
      RenderSystem.assertInInitPhase();
   ...
   @Nullable
   private ByteBuffer readImage(InputSupplier imageSupplier, IntBuffer x, IntBuffer y, IntBuffer channels) throws IOException {
      RenderSystem.assertInInitPhase();
