...
public class RealmsResetWorldScreen extends RealmsScreen {
   ...
   void drawFrame(MatrixStack matrices, int x, int y, Text text, Identifier texture, boolean hovered, boolean mouseOver) {
      ...
      drawCenteredTextWithShadow(matrices, this.textRenderer, text, x + 30, y, k);
   ...
   class FrameButton extends ButtonWidget {
      ...
      public void renderButton(MatrixStack matrices, int mouseX, int mouseY, float delta) {
         RealmsResetWorldScreen.this.drawFrame(matrices, this.getX(), this.getY(), this.getMessage(), this.image, this.isSelected(), this.isMouseOver((double)mouseX, (double)mouseY));
      }
   }
}
