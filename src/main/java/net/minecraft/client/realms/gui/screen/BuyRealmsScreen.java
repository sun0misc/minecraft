...
extends RealmsScreen {
    ...
    private static final ButtonTextures CROSS_BUTTON_TEXTURES = new ButtonTextures(Identifier.method_60656("widget/cross_button"), Identifier.method_60656("widget/cross_button_highlighted"));
    ...
    protected void init() {
        ...
        if (this.trialAvailable) {
            this.trialButton = this.addDrawableChild(ButtonWidget.builder(Text.translatable("mco.selectServer.trial"), ConfirmLinkScreen.opening(this, "https://aka.ms/startjavarealmstrial")).dimensions(this.getRight() - 10 - 99, this.getBottom() - 10 - 4 - 40, 99, 20).build());
        }
        this.addDrawableChild(ButtonWidget.builder(Text.translatable("mco.selectServer.buy"), ConfirmLinkScreen.opening(this, "https://aka.ms/BuyJavaRealms")).dimensions(this.getRight() - 10 - 99, this.getBottom() - 10 - 20, 99, 20).build());
