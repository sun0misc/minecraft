...
public class RealmsBackupInfoScreen extends RealmsScreen {
   ...
   class BackupInfoListEntry extends AlwaysSelectedEntryListWidget.Entry {
      ...
      public void render(MatrixStack matrices, int index, int y, int x, int entryWidth, int entryHeight, int mouseX, int mouseY, boolean hovered, float tickDelta) {
         ...
         DrawableHelper.drawTextWithShadow(matrices, lv, this.key, x, y, 10526880);
         DrawableHelper.drawTextWithShadow(matrices, lv, RealmsBackupInfoScreen.this.checkForSpecificMetadata(this.key, this.value), x, y + 12, 16777215);
      }
