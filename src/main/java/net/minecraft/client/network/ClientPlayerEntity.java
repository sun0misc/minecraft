...
public class ClientPlayerEntity extends AbstractClientPlayerEntity {
   ...
   private void sendMovementPackets() {
      ...
      if (this.isCamera()) {
         ...
         if (this.hasVehicle()) {
            ...
            this.networkHandler.sendPacket(new PlayerMoveC2SPacket.Full(lv2.x, -999.0, lv2.z, this.getYaw(), this.getPitch(), this.onGround));
            bl2 = false;
         } else if (bl2 && bl3) {
   ...
   private boolean wouldCollideAt(BlockPos pos) {
      ...
      return this.world.canCollide(this, lv2);
   }
         ...
         if (!(l < -0.15F)) {
            ...
            if (lv9.getCollisionShape(this.world, lv8, lv7).isEmpty()) {
               ...
               if (lv10.getCollisionShape(this.world, lv8, lv7).isEmpty()) {
                  ...
                  Iterable iterable = this.world.getCollisions(this, lv13);
