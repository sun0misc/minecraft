...
public class AllayEntity extends PathAwareEntity implements InventoryOwner {
   ...
   public AllayEntity(EntityType arg, World arg2) {
      ...
      PositionSource lv = new EntityPositionSource(this, this.getStandingEyeHeight());
      this.listenerCallback = new VibrationListenerCallback();
      this.gameEventHandler = new EntityGameEventHandler(new VibrationListener(lv, this.listenerCallback));
      this.jukeboxEventHandler = new EntityGameEventHandler(new JukeboxEventListener(lv, GameEvent.JUKEBOX_PLAY.getRange()));
   }
   ...
   public void tick() {
      ...
      if (this.world.isClient) {
         ...
         ((VibrationListener)this.gameEventHandler.getListener()).tick(this.world);
         if (this.isPanicking()) {
            this.setDancing(false);
         }
      }
   ...
   public boolean canGather(ItemStack stack) {
      ...
      return !lv.isEmpty() && this.world.getGameRules().getBoolean(GameRules.DO_MOB_GRIEFING) && this.inventory.canInsert(stack) && this.areItemsEqual(lv, stack);
   }
   ...
   public void writeCustomDataToNbt(NbtCompound nbt) {
      ...
      DataResult var10000 = VibrationListener.createCodec(this.listenerCallback).encodeStart(NbtOps.INSTANCE, (VibrationListener)this.gameEventHandler.getListener());
   ...
   public void readCustomDataFromNbt(NbtCompound nbt) {
      ...
      if (nbt.contains("listener", NbtElement.COMPOUND_TYPE)) {
         DataResult var10000 = VibrationListener.createCodec(this.listenerCallback).parse(new Dynamic(NbtOps.INSTANCE, nbt.getCompound("listener")));
         Logger var10001 = LOGGER;
         Objects.requireNonNull(var10001);
   ...
   private void duplicate() {
      AllayEntity lv = (AllayEntity)EntityType.ALLAY.create(this.world);
      if (lv != null) {
