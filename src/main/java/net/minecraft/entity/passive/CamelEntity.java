...
public class CamelEntity extends AbstractHorseEntity implements JumpingMount, AttackPosOffsettingMount, Saddleable {
   ...
   protected void mobTick() {
      ...
      lv.tick((ServerWorld)this.world, this);
   ...
   public void tick() {
      ...
      if (this.dashCooldown > 0) {
         --this.dashCooldown;
         if (this.dashCooldown == 0) {
            this.world.playSound((PlayerEntity)null, this.getBlockPos(), SoundEvents.ENTITY_CAMEL_DASH_READY, SoundCategory.NEUTRAL, 1.0F, 1.0F);
         }
      }
   ...
   public long getLastPoseTickDelta() {
      return this.world.getTime() - Math.abs((Long)this.dataTracker.get(LAST_POSE_TICK));
   }
