   ...
   static class FlyOntoTreeGoal extends FlyGoal {
      ...
      private Vec3d locateTree() {
         ...
         do {
            ...
            BlockState lv5 = this.mob.world.getBlockState(lv3.set(lv4, (Direction)Direction.DOWN));
            bl = lv5.getBlock() instanceof LeavesBlock || lv5.isIn(BlockTags.LOGS);
         } while(!bl || !this.mob.world.isAir(lv4) || !this.mob.world.isAir(lv2.set(lv4, (Direction)Direction.UP)));
