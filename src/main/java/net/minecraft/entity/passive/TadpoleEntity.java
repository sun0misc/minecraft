...
extends FishEntity {
    ...
    private void growUp() {
        ...
        if (world instanceof ServerWorld) {
            ...
            FrogEntity lv2 = EntityType.FROG.create(this.getWorld());
            if (lv2 != null) {
                lv2.refreshPositionAndAngles(this.getX(), this.getY(), this.getZ(), this.getYaw(), this.getPitch());
                lv2.initialize(lv, this.getWorld().getLocalDifficulty(lv2.getBlockPos()), SpawnReason.CONVERSION, null);
                ...
                lv2.setPersistent();
                lv2.recalculateDimensions(this.getDimensions(this.getPose()));
