    ...
    public void serverTick() {
        ...
        if (this.target.squaredDistanceTo(this.dragon) < 4096.0) {
            if (this.dragon.canSee(this.target)) {
                ...
                Vec3d lv2 = new Vec3d(MathHelper.sin(this.dragon.getYaw() * ((float)Math.PI / 180)), 0.0, -MathHelper.cos(this.dragon.getYaw() * ((float)Math.PI / 180))).normalize();
                ...
                if (this.seenTargetTimes >= 5 && k >= 0.0f && k < 10.0f) {
                    ...
                    Vec3d lv4 = new Vec3d(o, p, q);
                    if (!this.dragon.isSilent()) {
                        this.dragon.getWorld().syncWorldEvent(null, WorldEvents.ENDER_DRAGON_SHOOTS, this.dragon.getBlockPos(), 0);
                    }
                    DragonFireballEntity lv5 = new DragonFireballEntity(this.dragon.getWorld(), this.dragon, lv4.normalize());
                    lv5.refreshPositionAndAngles(l, m, n, 0.0f, 0.0f);
                    this.dragon.getWorld().spawnEntity(lv5);
