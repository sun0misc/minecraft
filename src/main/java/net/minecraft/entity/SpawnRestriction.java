...
public class SpawnRestriction {
   ...
   private static void register(EntityType type, Location location, Heightmap.Type heightmapType, SpawnPredicate predicate) {
   ...
   public static enum Location {
      ...
      // $FF: synthetic method
      private static Location[] method_36613() {
