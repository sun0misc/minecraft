...
public class IronGolemLookGoal extends Goal {
   ...
   public boolean canStart() {
      if (!this.golem.world.isDay()) {
         ...
         this.targetVillager = (VillagerEntity)this.golem.world.getClosestEntity(VillagerEntity.class, CLOSE_VILLAGER_PREDICATE, this.golem, this.golem.getX(), this.golem.getY(), this.golem.getZ(), this.golem.getBoundingBox().expand(6.0, 2.0, 6.0));
