...
extends HostileEntity {
    ...
    public EntityData initialize(ServerWorldAccess world, LocalDifficulty difficulty, SpawnReason spawnReason, @Nullable EntityData entityData) {
        ...
        if (lv.nextInt(100) == 0 && (lv2 = EntityType.SKELETON.create(this.getWorld())) != null) {
            lv2.refreshPositionAndAngles(this.getX(), this.getY(), this.getZ(), this.getYaw(), 0.0f);
            lv2.initialize(world, difficulty, spawnReason, null);
        ...
        if (entityData instanceof SpiderData) {
            SpiderData lv3 = (SpiderData)entityData;
            RegistryEntry<StatusEffect> lv4 = lv3.effect;
            if (lv4 != null) {
