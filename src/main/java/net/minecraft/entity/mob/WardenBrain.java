...
public class WardenBrain {
    ...
    protected static Brain<?> create(WardenEntity warden, Dynamic<?> dynamic) {
        ...
        Brain<WardenEntity> lv2 = lv.deserialize(dynamic);
        WardenBrain.addCoreActivities(lv2);
        WardenBrain.addEmergeActivities(lv2);
        WardenBrain.addDigActivities(lv2);
        WardenBrain.addIdleActivities(lv2);
        WardenBrain.addRoarActivities(lv2);
        WardenBrain.addFightActivities(warden, lv2);
        WardenBrain.addInvestigateActivities(lv2);
        WardenBrain.addSniffActivities(lv2);
