...
public abstract class MobEntity extends LivingEntity implements Targeter {
   ...
   public void tickMovement() {
      ...
      if (!this.world.isClient && this.canPickUpLoot() && this.isAlive() && !this.dead && this.world.getGameRules().getBoolean(GameRules.DO_MOB_GRIEFING)) {
         ...
         List list = this.world.getNonSpectatingEntities(ItemEntity.class, this.getBoundingBox().expand((double)lv.getX(), (double)lv.getY(), (double)lv.getZ()));
   ...
   public void checkDespawn() {
      if (this.world.getDifficulty() == Difficulty.PEACEFUL && this.isDisallowedInPeaceful()) {
         ...
         Entity lv = this.world.getClosestPlayer(this, -1.0);
         if (lv != null) {
      ...
      if (lv.isOf(Items.LEAD) && this.canBeLeashedBy(player)) {
         ...
         if (lv.getItem() instanceof SpawnEggItem) {
            if (this.world instanceof ServerWorld) {
               ...
               Optional optional = lv3.spawnBaby(player, this, this.getType(), (ServerWorld)this.world, this.getPos(), lv);
