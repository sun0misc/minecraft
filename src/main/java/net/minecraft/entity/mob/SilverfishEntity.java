...
extends HostileEntity {
                    ...
                    while (j <= 10 && j >= -10) {
                        ...
                        while (k <= 10 && k >= -10) {
                            ...
                            if (lv6 instanceof InfestedBlock) {
                                ...
                                if (lv2.nextBoolean()) break block0;
                            }
                            k = (k <= 0 ? 1 : 0) - k;
                        }
                        j = (j <= 0 ? 1 : 0) - j;
    ...
    extends WanderAroundGoal {
        ...
        public boolean canStart() {
            ...
            if (this.mob.getWorld().getGameRules().getBoolean(GameRules.DO_MOB_GRIEFING) && lv.nextInt(WanderAndInfestGoal.toGoalTicks(10)) == 0) {
        ...
        public void start() {
            ...
            World lv = this.mob.getWorld();
            BlockState lv3 = lv.getBlockState(lv2 = BlockPos.ofFloored(this.mob.getX(), this.mob.getY() + 0.5, this.mob.getZ()).offset(this.direction));
            if (InfestedBlock.isInfestable(lv3)) {
