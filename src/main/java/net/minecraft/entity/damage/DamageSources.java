...
public class DamageSources {
   ...
   private DamageSource create(RegistryKey key) {
      return new DamageSource(this.registry.entryOf(key));
   }

   private DamageSource create(RegistryKey key, @Nullable Entity attacker) {
      return new DamageSource(this.registry.entryOf(key), attacker);
   }

   private DamageSource create(RegistryKey key, @Nullable Entity source, @Nullable Entity attacker) {
