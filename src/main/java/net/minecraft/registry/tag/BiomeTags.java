...
public class BiomeTags {
    ...
    public static final TagKey<Biome> INCREASED_FIRE_BURNOUT = BiomeTags.of("increased_fire_burnout");
    public static final TagKey<Biome> SNOW_GOLEM_MELTS = BiomeTags.of("snow_golem_melts");
