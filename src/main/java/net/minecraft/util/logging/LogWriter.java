...
implements Closeable {
    ...
    public void write(T object) throws IOException {
        JsonElement jsonElement = this.codec.encodeStart(JsonOps.INSTANCE, (JsonElement)object).getOrThrow(IOException::new);
    ...
    public LogReader<T> getReader() throws IOException {
        ...
        final LogReader<T> lv = LogReader.create(this.codec, Channels.newReader((ReadableByteChannel)this.channel, StandardCharsets.UTF_8));
