...
public class DataComponentTypes {
    ...
    public static final ComponentType<class_9792> JUKEBOX_PLAYABLE = DataComponentTypes.register("jukebox_playable", arg -> arg.codec(class_9792.field_52025).packetCodec(class_9792.field_52026));
